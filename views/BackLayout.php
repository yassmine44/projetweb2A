            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  ...
                  <div class="preview-item-content flex-grow py-2">
                    <p class="preview-subject ellipsis font-weight-medium text-dark">skander ghanemm </p>
                    <p class="font-weight-light small-text"> The meeting is cancelled </p>
                  </div>
                </a>
                <a class="dropdown-item preview-item">
                  ...
                  <div class="preview-item-content flex-grow py-2">
                    <p class="preview-subject ellipsis font-weight-medium text-dark"> aziz douaji  </p>
                    <p class="font-weight-light small-text"> The meeting is cancelled </p>
                  </div>
                </a>
              </div>
            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  ...
                  <p class="font-weight-light text-muted mb-0">mohamed.aziz.cherif.1t@esprit.tn</p>
                </div>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="afficherevents.php">
                <i class="menu-icon typcn typcn-document-text"></i>
                <span class="menu-title">Afficher less offres</span>
              </a>
            </li>
            <li class="nav-item">
