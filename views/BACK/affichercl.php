...
// Retrieve the sorted list of users
$listeUsers = $clientC->triByExp($direction);
if (isset($_GET['recherche'])) {
	$listeUsers=$clientC->recherche($_GET['recherche']);
  }
?>
            ...
            <div class="container-fluid">
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">CONDIDATS</a></li>
					</ol>
                </div>
                <!-- row -->
        ...
        <div class="navbar-search-block">
          <form action=""  class="form-inline"  >
            <div class="input-group input-group-sm">
              <input class="form-control form-control-navbar" type="search" name="recherche" placeholder="Search By Country" aria-label="Search">
              <div class="input-group-append">
            ...
            <div class="card">
			  ...
			  <div class="main-panel">
                <form method="GET" action="">
                    <label for="sortDirection">Sort by Experience:</label>
                    ...
                    <?php foreach($listeUsers as $user): ?>
                      <tr>
                        ...
                        <td>
                            ...
                            if (!empty($user['cv'])) {
                                // Display the CV
                                echo '<img src="../BackAssets/images/' . $user['cv'] . '" style="max-width: 100px; max-height: 100px;" />';
                            } else {
                                echo 'No CV';
                            }
                            ?>
                        ...
                        <td>
						<form method="POST" action="../BACK/supprimerclient.php">
                                        <button type="submit" class="btn btn-danger btn-fw" name="supprimer">Supprimer</button>
                                        <input type="hidden" value="<?php echo $user['id']; ?>" name="id">
                                    </form><a class="btn btn-primary btn-fw" href="../BACK/modifierclient.php?id=<?php echo $user['id']; ?>">Modifier</a>
