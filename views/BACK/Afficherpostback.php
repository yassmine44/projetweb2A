            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/INTEGRATIONWEB/VIEWS/blog.php">site web</a></li>
				...
				<div class="copyright">
                <p><strong>JOBFLEX</strong> © 2024 All Rights Reserved Jobflex</p>				
                ...
                <table class="table">
					...
					<?php foreach ($tab as $rec) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="modifierpostback.php?id=<?php echo $rec['id_post']; ?>"><button class="btn btn-outline-success btn-sm">Modifier</button></a>
