    ...
    ***********************************-->
    ...
    <?php endif; ?>
							...
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									<img src="../../BackAssets/images/faces/a.jpg" width="56" alt="">
								</a>
								<div class="dropdown-menu dropdown-menu-end">
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
							<i class="fas fa-table"></i>
							<span class="nav-text">Ajout</span>
						</a>
                        <ul aria-expanded="false">
                            <li><a href="empty-page.php">Ajout D'Un Offre</a></li>
                            <li><a href="0.php">Ajout</a></li>
    ...
    <tr>
        ...
        <td>
		<form method="POST" action="/thisis/views/supprimerevents.php">
    ...
    <button type="submit" class="btn btn-danger btn-fw" name="supprimer">Supprimer</button>
				...
				<a class="btn btn-primary btn-fw" href="/thisis/views/modifierevents.php?IDoffre=<?PHP echo $event['IDoffre']; ?>"> Modifier </a>
