<?PHP session_start(); 
    ...
    $listeEvent = $eventC->triByExp($direction);
	if (isset($_GET['recherche'])) {
		$listeEvent=$eventC->recherche($_GET['recherche']);
		
	  }
	  $expiringOffers = $eventC->getExpiringOffers(7); // Change 7 to the number of days threshold
...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>Cherif's Dashboard</title>
    ...
    ***********************************-->
		...
		<div class="nav-header">
            <a href="index.php" class="brand-logo">
				...
				<div class="brand-title">
					<h2 class="">Job Flex.</h2>
					<span class="brand-sub-title">Cherif's Dashboard</span>
				</div>
            </a>
        ...
        ***********************************-->
                        ...
                        <div class="header-left">
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                                    ...
                                    <span class="badge light text-white bg-warning rounded-circle">5</span>
                                </a>
        ...
        <li>
            <div class="timeline-panel">
				...
				<h7 class="mb-1">ALERT!!!:</h7>
                    <h6 class="mb-1">Expired Offers:</h6>
                    <?php foreach ($expiringOffers as $offer) : ?>
						<small class="d-block" style="color: red; font-weight: bold;"><?php echo $offer['titreoffre']; ?>  expired on <?php echo $offer['datelimit']; ?>.</small>

                        <!-- You can also display the dataexpr value here if needed -->
                    <?php endforeach; ?>
                </div>
            </div>
        </li>
    <?php endif; ?>
							...
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
								<img src="../BackAssets/images/faces/a.jpg" alt="">
								</a>
								<div class="dropdown-menu dropdown-menu-end">
        ...
        ***********************************-->
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="condidatlist.php">Liste Des Candidats</a></li>

						</a>
                        
                    							<li><a href="offrelist.php">Liste Des Offre D'emploi</a></li>

                    </li>
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
							<i class="fas fa-table"></i>
							<span class="nav-text">Offre D'Emploi</span>
						</a>
                        <ul aria-expanded="false">
						<li><a href="empty-page.php">Ajout D'Un Offre</a></li>
                            <li><a href="afficherof.php">Afficher Les Offres</a></li>
                            <li><a href="affichercl.php">Afficher Les candidats</a></li>
							<li><a href="afificherpar.php">Afficher Les participants</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
							<i class="fas fa-table"></i>
							<span class="nav-text">Reclamation</span>
						</a>
                        <ul aria-expanded="false">
                        
							<li><a href="../BACK/Afficherreclamationback.php">Afficher les Reclamations</a></li>
							<li><a href="../BACK/Afficherreponseback.php">Afficher Les Reponses</a></li>
							<li><a href="../BACK/Ajouterreclamationback.php">Ajout d'une reclamation </a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
							<i class="fas fa-table"></i>
                        ...
                        <li><a href="Ajoutercommentback.php">Ajouter comment</a></li>
							...
							<li><a href="Affichercommentback.php">afficher comment</a></li>                 </ul>
                    </li>
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
							<i class="fas fa-clone"></i>
							<span class="nav-text">GO TO FRONT </span>						</a>
                        <ul aria-expanded="false">
                            <li><a href="/INTEGRATIONWEB/VIEWS/front/packages.php">site web</a></li>
				...
				<div class="side-bar-profile">
					<div class="d-flex align-items-center justify-content-between mb-3">
						...
						<div class="profile-info1">
							<h4 class="fs-18 font-w500">Mohamed Cherif</h4>
							<span>mohamed.aziz.cherif.1@esprit.tn</span>
						</div>
				...
				<div class="copyright">
					<p><strong>JOB FLEX</strong> © 2024 All Rights Reserved</p>
					<p class="fs-12">Made with <span class="heart"></span> by JOB FLEX Template</p>
				</div>
			</div>
        </div>
        <!--**********************************
        ...
        <div class="navbar-search-block">
          <form action=""  class="form-inline"  >
            <div class="input-group input-group-sm">
              <input class="form-control form-control-navbar" type="search" name="recherche" placeholder="Search By Titre De L'offre" aria-label="Search">
              <div class="input-group-append">
    ...
    <div class="content-wrapper"> 
		  ...
		  <?php if (!empty($expiringOffers)) : ?>
            <div class="alert alert-warning" role="alert">
                ...
                <?php foreach ($expiringOffers as $offer) : ?>
                    Offer '<?php echo $offer['titreoffre']; ?>' expired on <?php echo $offer['datelimit']; ?>.<br>
                <?php endforeach; ?>
            </div>
        <?php endif; ?> 
		-->
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="GET" action="">
                    <label for="sortDirection">Sort by Offer's ID:</label>
                ...
                <table class="table table-striped">
                  <thead>
                    <tr>
                      ...
                      <th>idUser</th> <!-- Added CV column header -->
                      <th>image de contrat</th> <!-- Added Exp column header -->
                    </tr>
                  </thead>
                  <tbody>
    ...
    <tr>
        ...
        <td><?PHP echo $event['titreoffre']; ?></td>
        <td><?PHP echo $event['datelimit']; ?></td>
        <td><?PHP echo $event['salaire']; ?></td>
        <td><?PHP echo $event['typecontrat']; ?></td>
        <td><?PHP echo $event['idfk']; ?></td>
        <td>
            <?php
            // Check if image data exists
            if (!empty($event['image'])) {
              // Display the image
              echo '<img src="../BackAssets/images/' . $event['image'] . '" style="max-width: 100px; max-height: 100px;" />';
          } else {
              echo 'No Image';
          }
        ...
        <td>
		<form method="POST" action="../BACK/supprimerevents.php">
    <input type="hidden" value="<?php echo $event['IDoffre']; ?>" name="IDoffre">
    <button type="submit" class="btn btn-danger btn-fw" name="supprimer">Supprimer</button>
</form>

				<a class="btn btn-primary btn-fw" href="../BACK/modifierevents.php?IDoffre=<?PHP echo $event['IDoffre']; ?>"> Modifier </a>
	...
	<?php endforeach; ?>
		  ...
		  <form action="sms.php" method="get">
                <button type="submit" class="btn btn-info btn-fw">Send SMS OFFERS</button>
            </form>

        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="../index.php" target="_blank">JOB FLEX TEAM</a> 2024</p>
            </div>
        </div>
        <!--**********************************
            Footer end
