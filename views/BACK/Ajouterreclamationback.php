            ...
            <div class="container-fluid">
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">   Ajout du réclamation</a></li>
					</ol>
                </div>
                <!-- row -->
  ...
  <div class="row">
    <div class="col-12">
      <div class="card recent-sales overflow-auto">
        <div class="card-body">
          <h5 class="card-title">Réclamations <span>| Ajout</span></h5>
          <br>
          <form method="POST" onsubmit="return verif();" action="Ajouterreclamationback.php">
            <div class="mb-5">
              <div class="row">
