				...
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="Afficherreclamationback.php">Afficher les Reclamations</a></li>
							<li><a href="Afficherreponseback.php">Afficher Les Reponses</a></li>
							<li><a href="Ajouterreclamationback.php">Ajout d'une reclamation </a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                            ...
                            <div class="row m-b-30">
                                <div class="col-md-5 col-xxl-12">
                                    <div class="new-arrival-product mb-4 mb-xxl-4 mb-md-0">
                                        <div class="new-arrivals-img-contnent">
                                            ...
                                            if (!empty($user['cv'])) {
                                                // Display the CV
                                                echo '<img class="img-fluid" src="/5555c/FrontAssets/images/' . $user['cv'] . '" alt="">';
                                            } else {
                                                // Provide a placeholder image if no CV is available
                                                echo '<img class="img-fluid" src="images/pic4.jpg" alt="Placeholder Image">';
                                            }
                                            ?>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-7 col-xxl-12">
                                    <div class="new-arrival-content position-relative">
                                        <h4> <p>Phone Number:<?php echo $user['nom'] ?><p></h4>
										<p>Skills :<?php echo $user['prenom']; ?></p>
                                        <p>Education: <?php echo $user['email']; ?></p>
                                        <p>Country: <?php echo $user['login']; ?></p>
                                        <p>Experience: <?php echo $user['exp']; ?></p>
                                        <!--
										<form method="POST" action="/thisis/views/supprimerclient.php">
                                        <button type="submit" class="btn btn-danger btn-fw" name="supprimer">Supprimer</button>
                                        <input type="hidden" value="<?php echo $user['id']; ?>" name="id">
                                    </form>                                            <a class="btn btn-primary btn-fw" href="modifierclient.php?id=<?php echo $user['id']; ?>">Modifier</a>
                                        -->
                                    </div>
                                </div>
                            </div>
