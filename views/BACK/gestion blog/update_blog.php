              ...
              <form role="form text-left" action="update.php?id=<?= $blog['id_blog']; ?>" method="post" enctype="multipart/form-data">
                  ...
                  <label for="nom"><b>Nom</b></label>
                   ...
                   <select class="form-control" id="type" name="type" required>
                        <option value="" <?= ($blog['type_blog'] == '') ? 'selected' : ''; ?> disabled>choisir le type</option>
                        <option value="Blog pédagogique" <?= ($blog['type_blog'] == 'Blog pédagogique') ? 'selected' : ''; ?> >Blog pédagogique</option>
                        <option value="blog de connaissance" <?= ($blog['type_blog'] == 'blog de connaissance') ? 'selected' : ''; ?> >blog de connaissance</option>
                        <option value="blog sur L'orientaion professionnel" <?= ($blog['type_blog'] == "blog sur L'orientaion professionnel") ? 'selected' : ''; ?> >blog sur L'orientaion professionnel</option>
                        <option value="blog de conseil et astuces" <?= ($blog['type_blog'] == 'blog de conseil et astuces') ? 'selected' : ''; ?> >blog de conseil et astuces</option>
                    </select>
