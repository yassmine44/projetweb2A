...
if (isset($_POST["aff"]) == "Tri" ) {
  $tab = $blogC->triReclamation();
} else if (isset($_POST["affi"] )== "Search") {
  $tab = $blogC->rechercheReclamation($_POST["rech"]);
} else
...
Affichage du Forums                            </div>
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									<img src="images/pic5.jpg" width="56" alt="">
								</a>
								<div class="dropdown-menu dropdown-menu-end">
				...
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="/INTEGRATIONWEB/views/back/index.html">Dashboard Light</a></li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                        <li><a href="/INTEGRATIONWEB/VIEWS/back/gestion%20blog/add_blog.php">Ajouter Forum</a></li>
                            <li><a href="/INTEGRATIONWEB/VIEWS/back/gestion%20blog/gestion_blog.php">Afficher Forum </a></li>
                            <li><a href="/INTEGRATIONWEB/VIEWS/back/gestion%20blog/gestion_publication.php">Afficher Messages   </a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
							<i class="fas fa-table"></i>
                        ...
                        <ul aria-expanded="false">
						<li><a href="/INTEGRATIONWEB/VIEWS/BACK/index.php">Stats</a></li>
						<li><a href="../empty-page.php">Ajout offre</a></li>
                        <li><a href="/INTEGRATIONWEB/views/BACK/afficherof.php">Afficher Les Offres</a></li>
							<li><a href="/INTEGRATIONWEB/views/BACK/affichercl.php">Afficher Les candidats</a></li>
							<li><a href="/INTEGRATIONWEB/views/BACK/afificherpar.php">Afficher Les participants</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                        <li><a href="/INTEGRATIONWEB/views/back/Ajouterreclamationback.php">Ajouter Réclamation</a></li>
                            <li><a href="/INTEGRATIONWEB/views/back/Afficherreclamationback.php">Afficher Réclamation </a></li>
                            <li><a href="/INTEGRATIONWEB/views/back/Afficherreponseback.php">Afficher Réponse   </a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
							<i class="fas fa-table"></i>
                        ...
                        <ul aria-expanded="false">
                        <li><a href="/INTEGRATIONWEB/views/back/table-datatable-entretien.php"> listes des entretiens</a></li>
                                           </ul>
                    </li>
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
							<i class="fas fa-table"></i>
                        ...
                        <ul aria-expanded="false">
                        <li><a href="/INTEGRATIONWEB/views/back/table-datatable-basic.php">liste des entreprise</a></li>
                                             </ul>
                    </li>
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
							<i class="fas fa-table"></i>
                        ...
                        <ul aria-expanded="false">
                        <li><a href="/INTEGRATIONWEB/views/back/table-datatable-user.php">liste des user</a></li>
                                             </ul>
                    </li>
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
							<i class="fas fa-table"></i>
                        ...
                        <ul aria-expanded="false">
                        <li><li><a href="/INTEGRATIONWEB/views/back/Ajoutercommentback.php">Ajouter comment</a></li>
                            <li><a href="/INTEGRATIONWEB/views/back/Ajouterpostback.php">ajouter post </a></li>
                            <li><a href="/INTEGRATIONWEB/views/back/Afficherpostback.php">Afficher post   </a></li>    
							<li><a href="/INTEGRATIONWEB/views/back/Affichercommentback.php">afficher comment</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="../../FRONT\gestion blog/blog.php">site web</a></li>
				...
				<div class="side-bar-profile">
					<div class="d-flex align-items-center justify-content-between mb-3">
						...
						<div class="profile-info1">
							...
							<span>cskanderghannem@gmail.com</span>
						</div>
            ...
            <div class="card-body">
              <form role="form text-left" action="add_blog.php" method="post" enctype="multipart/form-data">
                  ...
                  <label for="nom"><b>titre</b></label>
                   <input type="text" placeholder="Enter titre" class="form-control" name="nom" id="nom" required>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Blogs table</h6>
			 <form action="gestion_blog.php"><input type="submit" class="btn btn-outline-primary btn-sm" name="aff" value="Tri" /></form> 
            </div>
            <div class="card-body px-0 pt-0 pb-2">
