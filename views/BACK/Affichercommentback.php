...
Affichage du comments                            </div>
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown  header-profile">
								...
								<div class="dropdown-menu dropdown-menu-end">
									<a href="blog.php" class="dropdown-item ai-icon">
            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
						<li><a href="../BACK/index.php">Stats</a></li>
						<li><a href="../BACK/empty-page.php">Ajout offre</a></li>
                        <li><a href="../BACK/afficherof.php">Afficher Les Offres</a></li>
							<li><a href="../BACK/affichercl.php">Afficher Les candidats</a></li>
							<li><a href="../BACK/afificherpar.php">Afficher Les participants</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                        <li><li><a href="Ajoutercommentback.php">Ajouter comment</a></li>
				...
				<div class="side-bar-profile">
					<div class="d-flex align-items-center justify-content-between mb-3">
						...
						<div class="profile-info1">
							<h4 class="fs-18 font-w500">megbli yassmine</h4>
                ...
                <table class="table">
					...
					<?php foreach ($tab as $rec) { ?>
                        <tr>
                            ...
                            <td> <?= $rec['contenu'] ?> </td>
                            <td>
                                <a href="modifiercommentback.php?id=<?php echo $rec['idc']; ?>"><button class="btn btn-outline-success btn-sm">Modifier</button></a>
								<a href="mailing.php?id=<?php echo $rec['email']; ?>"><button class="btn btn-outline-danger btn-sm">send_mail</button></a><br><br>
                                <a href="delete.php?id=<?php echo $rec['idc']; ?>"><button class="btn btn-outline-danger btn-sm">Supprimer</button></a><br><br>
