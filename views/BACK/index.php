...
require_once '../../controller/clientC.php'; // Replace 'path_to_your_client_controller_file.php' with the actual path to your client controller file
...
// Get the client counts by contract type
$clientCounts = $clientController->getClientCountByContractType();

// Loop through the result to get counts for each contract type
$cddClients = 0;
$cdiClients = 0;
$stageClients = 0;

foreach ($clientCounts as $clientCount) {
	if ($clientCount['typecontrat'] === 'CDD') {
		$cddClients = $clientCount['client_count'];
	} elseif ($clientCount['typecontrat'] === 'CDI') {
		$cdiClients = $clientCount['client_count'];
	} elseif ($clientCount['typecontrat'] === 'Stage') {
		$stageClients = $clientCount['client_count'];
	}
}
...
<head>
	...
	<style>
		...
		.cdi {
			transform: rotate(calc(var(--size) * 3.6deg));
			background-color: #26E023;
		}

		.stage {
			transform: rotate(calc(var(--size) * 3.6deg));
			background-color: #61CFF1;
		}
	</style>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        ***********************************-->
		<div class="dlabnav">
			<div class="dlabnav-scroll">
				...
				<div class="copyright">
					<p><strong>Job fLEX</strong> © 2021 All Rights Reserved</p>
					<p class="fs-12">Made with <span class="heart"></span> by BRABUS</p>
				</div>
			</div>
		</div>
		<!--**********************************
									...
									<div class="card-header border-0 flex-wrap">
										...
										<div class="d-flex align-items-center project-tab mb-2">
											...
											<div class="dropdown ms-2">
												...
												<div id="statisticsChart" style="height: 300px; margin-top: 50px;"></div>
												...
												<script>
													...
													new Morris.Bar({
														...
														data: [{
																...
																value: <?php echo $averageSalary; ?>
															},
															{
																label: 'Event Count',
																value: <?php echo $eventCount; ?>
															},
															{
																label: 'Max Salary',
											...
											<div class="col-xl-6 col-xxl-12 col-sm-6">
												<div class="card">
													<div class="card-header border-0">
														<div>
															<h4 class="fs-20 font-w700">Candidats Candidats :</h4>
														</div>
													</div>
													<div class="card-body">
														<!-- Replace the emailchart div with your pie chart -->
														<div class="container">
    <div class="row">
        <div class="col-md-6">
...
<!-- Include your JavaScript code for rendering the pie chart -->
<script>
    window.onload = function() {
        var chart = new CanvasJS.Chart("chartContainer", {
            ...
            title: {
                text: "Client Count by Contract Type"
            },
            data: [{
                type: "pie",
                indexLabel: "{y}",
                ...
                legendText: "{label}",
                dataPoints: <?php
                    // Include necessary dependencies and fetch data from another file
                    require_once '../../controller/clientC.php';
                    $clientCounts = clientC::getClientCountByContractType();
                    // Prepare data for the chart
                    $dataPoints = [];
                    foreach ($clientCounts as $row) {
                        $dataPoints[] = array("label" => $row['typecontrat'], "y" => (int)$row['client_count']);
                    }
        ...
        chart.render();
														...
														<div class="mb-3 mt-4">
															<h4 class="fs-18 font-w600">Les Types Des Contrats</h4>
														</div>
														<div>
															<div class="d-flex align-items-center justify-content-between mb-4">
																...
																<span class="fs-18 font-w600"><?= $cddClients ?></span>
															</div>
															<div class="d-flex align-items-center justify-content-between  mb-4">
																<span class="fs-18 font-w500">
																	<svg class="me-3" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
																...
																<span class="fs-18 font-w600"><?= $cdiClients ?></span>
															</div>
															<div class="d-flex align-items-center justify-content-between  mb-4">
																<span class="fs-18 font-w500">
																	<svg class="me-3" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
																...
																<span class="fs-18 font-w600"><?= $stageClients ?></span>
															</div>
														</div>
													</div>
        ...
        ***********************************-->
		<div class="footer">
			<div class="copyright">
				<p>Copyright © Designed &amp; Developed by <a href="../index.htm" target="_blank">Job Flex</a> 2021</p>
			</div>
		</div>
		<!--**********************************
            Footer end
