...
$dbname = "sunandfun"; // Your MySQL database name
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $event = array(
			'title' => $row['titreoffre'] . "\n/ " . $row['typecontrat'] ."\n/ " . $row['salaire'] ,
            'start' => $row['datelimit'],
            'description' => 'Type: ' . $row['typecontrat'] . ', Salary: ' . $row['salaire'],
    ...
    ***********************************-->
    <div id="main-wrapper">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="calendar.php">Calendar</a></li>
									...
									<li><a href="offrelist.php">Liste Offres D'emploi</a></li>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by  <a href="../index.htm" target="_blank">JOB FLEX</a> 2024</p>
            </div>
        </div>
        <!--**********************************
            Footer end
	...
	<script>
        function fullCalendar(events) {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: events // Pass the offer data to events
            });
            calendar.render();
        }

        // Call fullCalendar function with offer data
        fullCalendar(<?php echo json_encode($calendarEvents); ?>);
    </script>
