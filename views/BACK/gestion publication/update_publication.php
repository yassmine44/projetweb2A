...
if (isset($_GET['id'])) {
    $current_id = $_GET['id'];
    $publication = $publicationC->getPublication($current_id);

    $id_blog_options = $publicationC->generateBlogOptionsSelectedId($publication['id_blog']);
}
?>
...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../../../view/back/gestion publication/gestion_publication.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Publication</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Publication</h6>
        </nav>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Modifier Publication</h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
            <div class="card-body">
              <form role="form text-left" action="update.php?id=<?= $publication['id_publication']; ?>" method="post" enctype="multipart/form-data">

                    <label for="id_blog"><b>ID Blog</b></label>
                   ...
                   <div class="publication-picture-container" id="publication_pic_display">
                      ...
                      <img src="data:image/jpeg;base64,<?php echo base64_encode($publication['image_publication']); ?>" alt="Publication Photo" class="img-fluid">
                    </div>
                   ...
                   <label for="title_publication"><b>titre</b></label>
                    <input type="text" class="form-control" id="title_publication" name="title_publication" value="<?= $publication['title_publication']; ?>" placeholder="Enter titre" required />
                    <div id="title_publicationError" style="color: red;"></div>

                   <label for="contenu_publication"><b>Contenu</b></label>
                   <textarea class="form-control" placeholder="Enter contenu" name="contenu_publication" id="contenu_publication" cols="30" rows="10" required><?= $publication['contenu_publication']; ?></textarea>
                   <div id="contenu_publicationError" style="color: red;"></div>

                   <div class="text-center">
                   <input type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2" name="updatebtn" id="updatebtn" value="modifier" onclick="return verif_publication_update()">
                  </div>
  ...
  <script src="../../../js/publication/publication_js.js"></script>
</body>
