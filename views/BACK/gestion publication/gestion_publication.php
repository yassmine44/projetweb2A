...
$publications = $publicationC->listPublications();

$id_blog_options = $publicationC->generateBlogOptions();
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Ajout Messagee</h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
            <div class="card-body">
              <form role="form text-left" action="add_publication.php" method="post" enctype="multipart/form-data">

                    <label for="id_blog"><b>ID forum</b></label>
                    <select class="form-control" id="id_blog" name="id_blog" required>
                        <option value="" selected disabled>choisir le titre</option>
                        <?php echo $id_blog_options; ?>
                    </select>
                    <div id="id_blogError" style="color: red;"></div>

                   
                   <label for="title_publication"><b>nom</b></label>
                    <input type="text" class="form-control" id="title_publication" name="title_publication" placeholder="Enter nom" required />
                    <div id="title_publicationError" style="color: red;"></div>

                   <label for="contenu_publication"><b>Contenu</b></label>
                   <textarea class="form-control" placeholder="Enter contenu" name="contenu_publication" id="contenu_publication" cols="30" rows="10" required></textarea>
                   <div id="contenu_publicationError" style="color: red;"></div>

                   <div class="text-center">
                   <input type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2" name="addbtn" id="addbtn" value="Ajout" onclick="return verif_publication_add()">
                  </div>
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">id forum</th>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2">
                          <div class="my-auto">
                          <p class="text-sm font-weight-bold mb-0"><?= $publication['id_publication']; ?></p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div class="d-flex px-2">
                          <div class="my-auto">
                          <p class="text-sm font-weight-bold mb-0"><?= $publication['id_blog']; ?></p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div class="d-flex px-2">
                          <div class="my-auto">
                            <?php if ($publication['image_publication']): ?>
                      ...
                      <td>
                        <div class="d-flex px-2">
                          <div class="my-auto">
                          <p class="text-sm font-weight-bold mb-0"><?= $publication['title_publication']; ?></p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div class="d-flex px-2">
                          <div class="my-auto">
                          <p class="text-sm font-weight-bold mb-0"><?= $publication['contenu_publication']; ?></p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td>
                        <div class="d-flex px-2">
                          <div class="my-auto">
                          <p class="text-sm font-weight-bold mb-0"><?= $publication['date_publication']; ?></p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td class="align-middle">
                        ...
                        <a href="update_publication.php?id=<?= $publication['id_publication']; ?>">Update</a>
                      </button>
                      <button class="btn btn-link text-secondary mb-0">
                      <a href="delete_publication.php?id=<?= $publication['id_publication']; ?>">Delete</a>
                      </button>
                      </td>
                    </tr>
