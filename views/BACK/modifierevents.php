  ...
  session_start();
	...
	if (
		...
		if (
            ...
            echo "<script>alert('A JOB OFFER modified successfully'); window.location.href = '../BACK/afficherof.php';</script>";
        }
        else
...
<input type="reset" value="Annuler" class="btn btn-warning btn-fw" onclick="window.location.href='../BACK/afficherof.php';">
                            </div>
                        </div>
                    </form>
                </div>
