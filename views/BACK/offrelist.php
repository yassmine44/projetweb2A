				...
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="../BACK/ajouterreponseback.php">Ajout Reponse</a></li>
                        </ul>
                    </li>
					<li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
    ...
    <div class="container-fluid">
        <div class="row page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0)">offre</a></li>
            </ol>
        </div>
        <div class="row">
		<li class="nav-item">
                ...
                <div class="row m-b-30">
                        ...
                        <div class="new-arrival-product mb-4 mb-xxl-4 mb-md-0">
                            <div class="new-arrivals-img-contnent">
                                ...
                                if (!empty($event['image'])) {
                                    // Display the image
                                    echo '<img class="img-fluid" src="/5555c/FrontAssets/images/' . $event['image'] . '" alt="">';
                                } else {
                                    // Provide a placeholder image if no image is available
                                    echo '<img class="img-fluid" src="images/pic5.jpg" alt="Placeholder Image">';
                                }
                                ?>
                            </div>
                        </div>
                    ...
                    <div class="col-md-7 col-xxl-12">
                        <div class="new-arrival-content position-relative">
                            <h4><?php echo $event['titreoffre']; ?></h4>
                            <p>Date limite: <?php echo $event['datelimit']; ?></p>
                            <p>Salaire: <?php echo $event['salaire']; ?></p>
                            <p>Type de contrat: <?php echo $event['typecontrat']; ?></p>
                            <p>Identifiant: <?php echo $event['idfk']; ?></p>
                            <!--
                            ...
                            <a class="btn btn-primary btn-fw" href="modifierevents.php?IDoffre=<?php echo $event['IDoffre']; ?>">Modifier</a>
							-->
                        </div>
                    </div>
                </div>
