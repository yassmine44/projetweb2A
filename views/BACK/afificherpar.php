...
$listeParticipants = $clientC->getAllParticipants($pdo);
        ...
        ***********************************-->
		<div class="nav-header">
            <a href="index.html" class="brand-logo">
				<svg class="" width="55" height="55" viewbox="0 0 55 55" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<div class="brand-title">
					<h2 class="">JobFlex.</h2>
					<span class="">Cherif's Dashboard</span>
				</div>
            </a>
        ...
        <li>
            <div class="timeline-panel">
				...
				<h7 class="mb-1">ALERT!!!:</h7>
                    <h6 class="mb-1">Expiring Offers:</h6>
                    <?php foreach ($expiringOffers as $offer) : ?>
						<small class="d-block" style="color: red; font-weight: bold;"><?php echo $offer['titreoffre']; ?> is expiring on <?php echo $offer['datelimit']; ?>.</small>
    ...
    <div class="content-wrapper"> 
		  ...
		  <?php if (!empty($expiringOffers)) : ?>
            <div class="alert alert-warning" role="alert">
                <strong>Expiring Offers:</strong>
                <?php foreach ($expiringOffers as $offer) : ?>
                    Offer '<?php echo $offer['titreoffre']; ?>' is expiring on <?php echo $offer['datelimit']; ?>.<br>
                <?php endforeach; ?>
            </div>
        <?php endif; ?> 
		-->
                ...
                <table class="table table-striped">
                  <thead>
                    <tr>
                      ...
                      <th>Skills </th>
                      <th>Education</th>
                      <th>Country</th> <!-- Added CV column header -->
                      <th>CV Pdf</th> <!-- Added Exp column header -->
                    </tr>
                  </thead>
                  <tbody>
                  <?php
foreach ($listeParticipants as $participant) {
    ...
    <tr>
        ...
        <td><?php echo $participant['OffreFK']; ?></td> <!-- Display ID of the offer -->
...
?>
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="../index.htm" target="_blank">JOB FLEX TEAM</a> 2024</p>
            </div>
        </div>
        <!--**********************************
            Footer end
