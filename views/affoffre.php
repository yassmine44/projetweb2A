                    ...
                    echo '
                        <div class="col-md-4">
                            <div class="product-item">
                                <a href="package-details.html"><img src="/5555c/FrontAssets/images/'. $event['image']. '" alt="Image"></a>
                                <div class="down-content">
                                    <a href="package-details.html"><h4>'. $event['titreoffre']. '</h4></a>
                                    <h6>'. $event['typecontrat']. ' </h6>
                                    <p>Zid </p>
                                    <small>
                                        <strong title="Available"><i class="fa fa-calendar"></i> '. $event['datelimit']. ' </strong> &nbsp;&nbsp;&nbsp;&nbsp;
                                        <strong title="salaire de travail"><i class="fa fa-dollar-sign"></i> '. $event['salaire']. ' DT</h6> </strong>
                                        <form method="POST" action="ajoutercondidat.php">
                                            ...
                                            <input type="hidden" value="'. $event['IDoffre']. '" name="idoffre">
                                            <input type="hidden" value="'. $_SESSION['idfk']. '" name="idfk">
                                        </form>
                                    </small>
                                </div>
                            </div>
