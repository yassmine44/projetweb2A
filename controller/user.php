...
require 'C:/xampp/htdocs/INTEGRATIONWEB/views/vendorU/autoload.php';
include_once "C:/xampp/htdocs/INTEGRATIONWEB/config.php";
//include "C:/xampp/htdocs/INTEGRATIONWEB/model/users.php";
...
class user {
    ...
    function sendPasswordResetEmail($email, $token) {
        ...
        try {
            ...
            $mail->Body    = "Bonjour,<br><br>Cliquez sur le lien suivant pour réinitialiser votre mot de passe : <a href='http://localhost/INTEGRATIONWEB/views/mdpreset.php?token=$token'>Réinitialiser le mot de passe</a>.";
            $mail->send();
