<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/extended-tippy-tooltips.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:51 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Tippy Tooltip | Konrix - Responsive Tailwind Admin Dashboard</title>
    ...
    <link
      href="assets/libs/tippy.js/tippy.css"
      rel="stylesheet"
      type="text/css"
    />
        ...
        <main class="flex-grow p-6">
          ...
          <div class="grid lg:grid-cols-2 grid-cols-1 gap-6">
            <div class="card">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="PlacementTooltips"
                    >
              ...
              <div class="p-6">
                ...
                <p class="text-sm text-slate-700 dark:text-slate-400 mb-3">
                  The default tippy tooltip looks like this when given no
                  options. It has a nifty backdrop filling animation!
                </p>
            ...
            <div class="card">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="InteractivityTooltip"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
              ...
              <div class="p-6">
                <p class="text-sm text-slate-700 dark:text-slate-400 mb-3">
                  Tooltips can be interactive, meaning they won't hide when you
                  hover over or click on them.
                </p>
                <div class="flex flex-wrap gap-2">
                  <span
                    class="btn btn-sm bg-primary text-white"
                  ...
                  <span
                    ...
                    >Interactive (click)</span
                  >
                </div>
                <div
                  id="InteractivityTooltip"
                  class="hidden w-full overflow-hidden transition-[height] duration-300"
                >
                  <pre class="language-html h-auto">
                                    <code>
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="DurationTooltip"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="AnimationsTooltip"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
              ...
              <div class="p-6">
                ...
                <div class="flex flex-wrap gap-2">
                  ...
                  <span
                    ...
                    data-tippy-duration="[600, 300]"
                    data-tippy-arrow="true"
                    >Inertia (perspective)</span
                  >
                </div>

                <div
                  id="AnimationsTooltip"
                  class="hidden w-full overflow-hidden transition-[height] duration-300"
                >
                  <pre class="language-html h-auto">
                                    <code>
            ...
            <div class="card">
              ...
              <div class="p-6">
                <p class="text-sm text-slate-700 dark:text-slate-400 mb-3">
                  A tippy can have any kind of theme you want! Creating a custom
                  theme is a breeze.
                </p>
                <div class="flex flex-wrap gap-2">
                  <span
