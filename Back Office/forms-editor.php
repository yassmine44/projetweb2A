<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/forms-editor.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:58 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Form Editor | Konrix - Responsive Tailwind Admin Dashboard</title>
    ...
    <!-- quill css -->
    <link
      href="assets/libs/quill/quill.core.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
      href="assets/libs/quill/quill.bubble.css"
      rel="stylesheet"
      type="text/css"
    />
    <link
      href="assets/libs/quill/quill.snow.css"
      rel="stylesheet"
      type="text/css"
    />
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="BubbleEditorHtml"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
  ...
  <!-- Mirrored from coderthemes.com/konrix/layouts/forms-editor.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:45:00 GMT -->
</html>
