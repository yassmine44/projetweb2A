<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/ui-skeleton.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:41 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Skeleton | Konrix - Responsive Tailwind Admin Dashboard</title>
        ...
        <main class="flex-grow p-6">
          ...
          <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
            <div class="card">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="basictSkeletonHtml"
                    >
              ...
              <div class="p-6">
                <h3
                  class="h-4 bg-gray-200 rounded-md dark:bg-gray-700 w-2/5"
                ></h3>
                <ul class="mt-5 space-y-3">
                  <li
                    class="w-full h-4 bg-gray-200 rounded-md dark:bg-gray-700"
                  ></li>
                  <li
                    class="w-full h-4 bg-gray-200 rounded-md dark:bg-gray-700"
                  ></li>
            ...
            <div class="card">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="complextSkeletonHtml"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
              ...
              <div class="p-6">
                <h3
                  class="h-4 bg-gray-200 rounded-md dark:bg-gray-700 mb-3"
                  style="width: 40%"
                ></h3>
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="animationSkeletonHtml"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
