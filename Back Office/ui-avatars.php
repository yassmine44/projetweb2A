<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/ui-avatars.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:40 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Badge | Konrix - Responsive Tailwind Admin Dashboard</title>
          ...
          <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="#avatarSizingHtml"
                    >
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="#avatarCircleHtml"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="#AvatarCircle_2Html"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
              ...
              <div class="p-6">
                <div class="flex flex-wrap items-end gap-3">
                  <div class="relative h-8 w-8 inline-flex">
                    ...
                    />
                    <div
                      class="absolute end-0 h-2 w-2 rounded-full border border-white bg-success"
                    ></div>
                  </div>
            ...
            <div class="card">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="#Bg_Avatar_Rounded_Html"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
              ...
              <div class="p-6">
                <div class="flex flex-wrap items-end gap-3">
                  <div
                    class="w-8 h-8 justify-center items-center flex bg-primary rounded"
                  >
                    <span class="text-white">CT</span>
                  </div>

                  <div
                    class="w-12 h-12 justify-center items-center flex bg-dark rounded"
                  >
                    <span class="text-white text-lg">CT</span>
                  </div>

                  <div
                    class="w-16 h-16 justify-center items-center flex bg-success rounded"
                  >
                    <span class="text-white text-xl">CT</span>
                  </div>

                  <div
                    class="w-20 h-20 justify-center items-center flex bg-info rounded"
                  >
                    <span class="text-white text-2xl">CT</span>
                  </div>

                  <div
                    class="w-24 h-24 justify-center items-center flex bg-danger rounded"
                  >
                    <span class="text-white text-2xl">CT</span>
                  </div>

                  <div
                    class="w-28 h-28 justify-center items-center flex bg-info/25 rounded"
                  >
                    <span class="text-info text-3xl">CT</span>
                  </div>

                  <div
                    class="w-32 h-32 justify-center items-center flex bg-primary/25 rounded"
                  >
                    <span class="text-primary text-4xl">CT</span>
                  </div>
                </div>
                <div
                  id="Bg_Avatar_Rounded_Html"
                  class="hidden w-full overflow-hidden transition-[height] duration-300"
                >
                  <pre class="language-html h-56">
                                    <code>
            ...
            <div class="card">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="#Bg_Avatar_Circle_Html"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
              ...
              <div class="p-6">
                <div class="flex flex-wrap items-end gap-3">
                  <div
                    class="w-8 h-8 justify-center items-center flex bg-primary rounded-full"
                  >
                    <span class="text-white">CT</span>
                  </div>

                  <div
                    class="w-12 h-12 justify-center items-center flex bg-dark rounded-full"
                  >
                    <span class="text-white text-lg">CT</span>
                  </div>

                  <div
                    class="w-16 h-16 justify-center items-center flex bg-success rounded-full"
                  >
                    <span class="text-white text-xl">CT</span>
                  </div>

                  <div
                    class="w-20 h-20 justify-center items-center flex bg-info rounded-full"
                  >
                    <span class="text-white text-2xl">CT</span>
                  </div>

                  <div
                    class="w-24 h-24 justify-center items-center flex bg-danger rounded-full"
                  >
                    <span class="text-white text-2xl">CT</span>
                  </div>

                  <div
                    class="w-28 h-28 justify-center items-center flex bg-info/25 rounded-full"
                  >
                    <span class="text-info text-3xl">CT</span>
                  </div>

                  <div
                    class="w-32 h-32 justify-center items-center flex bg-primary/25 rounded-full"
                  >
                    <span class="text-primary text-4xl">CT</span>
                  </div>
                </div>
                <div
                  id="Bg_Avatar_Circle_Html"
                  class="hidden w-full overflow-hidden transition-[height] duration-300"
                >
                  <pre class="language-html h-56">
                                    <code>
            ...
            <div class="card">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="#Bg_Avatar_Circle_2_Html"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
              ...
              <div class="p-6">
                <div class="flex flex-wrap items-end gap-3">
                  ...
                  <div class="relative inline-flex">
                    <div
                      class="w-16 h-16 justify-center items-center flex bg-success/25 rounded-full"
                    >
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="#Avatar_Circle_Bottom_Html"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="#Avatar_Circle_Rounded_Html"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="#Avatar_Media_Html"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="#Avatar_Img_bg_Html"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="#Avatar_Stack_Html"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="#Avatar_border_Html"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="#Avatar_Grid_Html"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
