<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/docs-introduction.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:45:10 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Introducation | Konrix - Responsive Tailwind Admin Dashboard</title>
        ...
        <main class="flex-grow p-6">
          ...
          <div class="flex flex-col gap-6">
            <div class="card">
              <div class="p-6">
                <p>
                  Konrix is a fully featured premium admin template built on top
                  of awesome
                  <strong class="text-danger">Tailwind v3</strong>. It's crafted
                ...
                <p>
                  This documentation is guidelines for all users who can even be
                  a beginner or experienced web developer.
                </p>
                <p>
                  ...
                  <a
                    href="http://coderthemes.com/#contact"
                    class="text-primary"
                    target="_blank"
                    >website</a
                  >.
