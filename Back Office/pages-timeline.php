<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/pages-timeline.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:30 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Timeline | Konrix - Responsive Tailwind Admin Dashboard</title>
                  ...
                  <div class="relative md:ms-10 ms-20">
                    <div class="card p-5">
                      ...
                      <p class="text-gray-500 dark:text-gray-200">
                        ...
                        <span><a href="#">Pathek</a></span> Lorem ipsum dolor
                  ...
                  <div class="relative md:me-10 md:ms-0 ms-20">
                    <div class="card p-5">
                      ...
                      <p class="text-gray-500 dark:text-gray-200">
                        ...
                        the doctor <span><a href="#"> Johm meon </a></span>
                      </p>
                    </div>
                    <div
                      class="bg-white dark:bg-gray-800 absolute h-4 w-4 rotate-45 rounded-sm top-7 md:-end-2 md:start-auto -start-2"
                ...
                <div class="md:col-span-1 col-span-2">
                  <div class="relative md:me-10 md:ms-0 ms-20">
                    <div class="card p-5">
                      ...
                      <p class="text-gray-500 dark:text-gray-200">
                        Jonatha Smith added new milestone
                        <span><a class="blue" href="#">crishtian</a></span>
                ...
                <div class="md:col-span-1 col-span-2">
                  <div class="relative md:me-10 md:ms-0 ms-20">
                    <div class="card p-5">
                      ...
                      <p class="text-gray-500 dark:text-gray-200">
                        Jonatha Smith added new milestone
                        <span><a href="#">prank</a></span> Lorem ipsum dolor sit
                        amet consiquest dio
                      </p>
                    </div>
                    <div
  ...
  <!-- Mirrored from coderthemes.com/konrix/layouts/pages-timeline.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:31 GMT -->
</html>
