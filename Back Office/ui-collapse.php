<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/ui-collapse.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:41 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Collapse | Konrix - Responsive Tailwind Admin Dashboard</title>
          ...
          <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
            <div class="card">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="collapseWithTargetHTML"
                    >
              ...
              <div class="p-6">
                <button
                  data-fc-type="collapse"
                  data-fc-target="collapseWithTarget"
                  type="button"
                  class="btn bg-primary text-white"
                >
                  Collapse
                  <i
                    class="mgc_down_line fc-collapse-open:rotate-180 ms-2 transition-all text-xl"
                  ></i>
                </button>

                <div
                  id="collapseWithTarget"
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="collapseAutoTargetHTML"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
                ...
                <div class="flex justify-between items-center pe-[15px]">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="collapseReadMoreHTML"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
