...
class ThemeCustomizer {
  constructor() {
    (this.php = document.getElementsByTagName("html")[0]),
      (this.config = {}),
    ...
    document.querySelectorAll("ul.menu a.menu-link").forEach((t) => {
      ...
      setTimeout(function () {
        ...
        null != t &&
          ...
          e &&
            100 < t &&
            ((o = 600), (c = (i = e).scrollTop), (a = t - c), (d = 0), r()));
      }, 200);
  }
  reverseQuery(e, t) {
    for (; e; ) {
  ...
  changeThemeDirection(e) {
    (this.config.direction = e),
      this.php.setAttribute("dir", e),
      this.setSwitchFromConfig();
  }
  changeThemeMode(e) {
    (this.config.theme = e),
      this.php.setAttribute("data-mode", e),
      this.setSwitchFromConfig();
  }
  changeLayoutWidth(e, t = !0) {
    this.php.setAttribute("data-layout-width", e),
      t && ((this.config.layout.width = e), this.setSwitchFromConfig());
  }
  changeLayoutPosition(e, t = !0) {
    this.php.setAttribute("data-layout-position", e),
      t && ((this.config.layout.position = e), this.setSwitchFromConfig());
  }
  changeTopbarColor(e) {
    (this.config.topbar.color = e),
      this.php.setAttribute("data-topbar-color", e),
      this.setSwitchFromConfig();
  }
  changeMenuColor(e) {
    (this.config.menu.color = e),
      this.php.setAttribute("data-menu-color", e),
      this.setSwitchFromConfig();
  }
  changeSidenavView(e, t = !0) {
    this.php.setAttribute("data-sidenav-view", e),
        ...
        (e &&
          e.addEventListener("click", function () {
            var e = n.config.sidenav.view,
              t = n.php.getAttribute("data-sidenav-view", e);
            "mobile" === t
              ? (n.showBackdrop(), n.php.classList.toggle("sidenav-enable"))
              : "hidden" == e
              ? "hidden" === t
  ...
  showBackdrop() {
    const e = document.createElement("div"),
      t =
        ...
        this);
    e.addEventListener("click", function (e) {
      t.php.classList.remove("sidenav-enable"), t.hideBackdrop();
    });
  }
  hideBackdrop() {
  ...
  setSwitchFromConfig() {
    ...
    a &&
      ...
      (c = document.querySelector(
        "input[type=radio][name=data-menu-color][value=" + a.menu.color + "]"
      )),
