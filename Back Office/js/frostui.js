(function (b, S) {
  ...
  var Ae = (b, S, P) =>
    S in b
      ? _e(b, S, { enumerable: !0, configurable: !0, writable: !0, value: P })
      : (b[S] = P);
    ...
    F = class extends I {
      ...
      initOptions() {
        this._targetElement != null &&
          !this._targetElement.classList.contains(F.DEFAULT.class.hidden) &&
      ...
      hide() {
        this._destroyed ||
          ...
          this._targetElement != null &&
            ...
            Lt.afterTransition(this._targetElement, () => {
              this.isShown ||
                (this._targetElement.classList.add(F.DEFAULT.class.hidden),
      ...
      if (this._element != null) {
        ...
        if (!n) this.targetCollapses = t.map((s) => O.getInstanceOrCreate(s));
          ...
          this.targetCollapses = t
            .filter((a) => a.getAttribute(xt.DEFAULT.attr.parent) == s)
    ...
    initListeners() {
      this.targetCollapses.forEach((t) => {
        t.addEventListener(O.EVENTS.show, () => {
          this._destroyed ||
            this.targetCollapses.filter((n) => n != t).forEach((n) => n.hide());
        });
      });
    }
  };
  ...
  const ae = async (e, i, t) => {
    ...
    let h = await l.getElementRects({ reference: e, floating: i, strategy: s }),
      { x: f, y: c } = It(h, n, d),
      m = n,
      g = {},
      E = 0;
    ...
    const { x: n, y: s, platform: a, rects: l, elements: r, strategy: d } = e,
      ...
      L = yt(
        await a.getClippingRect({
          element:
            (t = await (a.isElement == null ? void 0 : a.isElement(u))) ==
              null || t
              ? u
              : u.contextElement ||
            ...
            if (
              ...
              let rt =
                (Et = lt
                  ...
                  .sort((tt, K) => tt.overflows[1] - K.overflows[1])[0]) == null
                  ? void 0
                  : Et.placement;
              if (!rt)
                switch (m) {
          ...
          async fn(i) {
            const { x: t, y: n } = i,
              s = await (async function (a, l) {
                ...
                return (
                  m && typeof _ == "number" && (y = m === "end" ? -1 * _ : _),
                  g ? { x: y * u, y: v * E } : { x: v * E, y: y * u }
                );
              })(i, e);
  ...
  function Wt() {
    ...
    return e && Array.isArray(e.brands)
      ? ((vt = e.brands.map((i) => i.brand + "/" + i.version).join(" ")), vt)
      : navigator.userAgent;
  }
  function V(e) {
    return e instanceof C(e).phpElement;
  }
  function G(e) {
  ...
  function Ct(e) {
    ...
    return (
      ...
      ["transform", "perspective"].some((s) => t.willChange.includes(s)) ||
  ...
  function gt(e, i, t, n) {
    ...
    let c =
        (l.left +
          ((f && ((s = h.visualViewport) == null ? void 0 : s.offsetLeft)) ||
            0)) /
        d.x,
      m =
        (l.top +
          ((f && ((a = h.visualViewport) == null ? void 0 : a.offsetTop)) ||
            0)) /
        d.y,
      g = l.width / d.x,
      E = l.height / d.y;
    ...
    T = class extends I {
      ...
      show() {
        this.dispatchEvent(T.EVENTS.show),
          ...
          this._targetElement != null &&
            this._element != null &&
            (this._targetElement.classList.remove(T.DEFAULT.class.hidden),
            setTimeout(() => {
      ...
      initOptions() {
        var t, n, s, a;
        if (
          ((t = this._element) == null || t.classList.add(T.DEFAULT.class.base),
          ...
          ((s = this._targetElement) == null
            ? void 0
            : s.classList.contains(T.DEFAULT.class.hidden)) === !1 &&
            this.show(),
            ...
            window.addEventListener("mousemove", (s) => {
              this._destroyed ||
                (this._targetElement != null &&
                  ...
                  !this.clicked &&
                  !p.isElementSameOrContains(this._targetElement, s.target) &&
                  !p.isElementSameOrContains(this._element, s.target) &&
                  this.hide());
            })),
  ...
  const A = class extends I {
    constructor(t, n) {
      ...
      o(this, "onWindowClicked", (t) => {
        !this.isStatic &&
          ...
          this._targetElement &&
          this.isShown &&
          (p.isElementContains(this._targetElement, t.target) || this.hide());
      });
      this.init();
    }
    get isShown() {
    ...
    initOptions() {
      ...
      t
        ...
        : this.config.behavior == null && (this.config.behavior = "default");
    }
    initListener() {
      var t;
      this._element != null &&
        ...
        (t = this._targetElement) == null ||
          t.querySelectorAll(`[${A.DEFAULT.attr.dismiss}]`).forEach((n) => {
    ...
    hide() {
      ...
      this.dispatchEvent(A.EVENTS.hide),
        this._targetElement != null &&
          this.isShown &&
          (document.body.classList.remove(A.DEFAULT.class.overflowHidden),
          (t = this._element) == null ||
    ...
    getTargetElement() {
      if (this._element == null) return null;
      const t =
        this.config.target ?? this._element.getAttribute(A.DEFAULT.attr.target);
      return typeof t == "string"
        ? p.findOrById(t)
        : t instanceof HTMLElement
        ? t
  ...
  const w = class extends I {
    ...
    show() {
      this.computeTooltipPosition(),
        ...
        this._targetElement != null &&
          this._element != null &&
          (this._targetElement.classList.remove(w.DEFAULT.class.hidden),
        ...
        (s = this._element) != null &&
          ...
          (this.config.trigger =
            ((a = this._element) == null
              ? void 0
              : a.getAttribute(w.DEFAULT.attr.trigger)) === "click"
              ? "click"
              : "hover"),
    ...
    computeTooltipPosition() {
      ...
      this._arrowElement && t.push(ce({ element: this._arrowElement })),
        this._element != null &&
          this._targetElement != null &&
          (this._targetElement.classList.add(w.DEFAULT.class.absolute),
          this._arrowElement &&
            this._arrowElement.classList.add(w.DEFAULT.class.absolute),
          ee(this._element, this._targetElement, {
            ...
            if (
              ...
              const { x: f, y: c } = a.arrow,
                m =
                  f != null
                    ? `${f}px`
                    : `${-this._arrowElement.offsetWidth / 2}px`,
                g =
                  c != null
                    ? `${c}px`
                    : `${-this._arrowElement.offsetHeight / 2}px`,
                E = {
                  left:
                    (l = this.config.placement) != null && l.includes("left")
                      ? null
                      : m,
                  top:
                    (r = this.config.placement) != null && r.includes("top")
                      ? null
                      : g,
                  right:
                    (d = this.config.placement) != null && d.includes("left")
                      ? m
                      : null,
                  bottom:
                    (h = this.config.placement) != null && h.includes("top")
                      ? g
                      : null,
                };
  ...
  const x = class extends I {
    ...
    initListener() {
      ...
      this._element != null &&
        ...
        (t = this._targetElement) == null ||
          t.querySelectorAll(`[${x.DEFAULT.attr.dismiss}]`).forEach((n) => {
            n.addEventListener("click", () => {
              this.hide();
            });
          }),
    ...
    getTargetElement() {
      if (this._element == null) return null;
      const t =
        this.config.target ?? this._element.getAttribute(x.DEFAULT.attr.target);
      return typeof t == "string"
        ? p.findOrById(t)
        : t instanceof HTMLElement
        ? t
  ...
  const ye = {
    ...
    St = class {
      static get state() {
        return (
          this._initialize || (this._initialize = this.retrieveFromLocal()),
          this._state
        );
      }
      static init() {
  ...
  const st = class extends I {
    ...
    notifyThemeChanged(t) {
      ...
      if (this.trigger != "switch")
        (n = this._element) == null ||
          n.classList.remove("light-theme", "dark-theme", "system-theme"),
  ...
  const kt = class {
    static get instance() {
      return (
        this._instance == null && (this._instance = new kt()), this._instance
      );
    }
    init() {
      typeof window < "u" &&
