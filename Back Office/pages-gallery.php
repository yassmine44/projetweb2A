<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/pages-gallery.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:31 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Gallery | Konrix - Responsive Tailwind Admin Dashboard</title>
          ...
          <div class="flex flex-col gap-6">
              ...
              <div class="p-6">
                <div class="flex justify-center">
                  <div class="w-full filters-group-wrap mb-3">
                    <div class="flex justify-center mb-5">
                      <ul
                        class="filter-options flex flex-wrap gap-4 justify-center"
                      >
                ...
                <div id="gallery-wrapper" class="flex justify-center">
                  ...
                  >
                    <a
                      class="image-popup"
                      href="assets/images/small/small-1.jpg"
                    >
                      <div
                  ...
                  <div
                    class="xl:w-1/4 lg:w-1/3 p-3 picture-item"
                    data-groups='["design", "digital"]'
                  >
                    <a
                      class="image-popup"
                      href="assets/images/small/small-2.jpg"
                    >
                      <div
                        class="relative block overflow-hidden rounded group transition-all duration-500"
                      >
                  ...
                  >
                    <a
                      class="image-popup"
                      href="assets/images/small/small-3.jpg"
                    >
                      <div
                        class="relative block overflow-hidden rounded group transition-all duration-500"
                      >
                  ...
                  <div
                    class="xl:w-1/4 lg:w-1/3 p-3 picture-item"
                    data-groups='["design", "photography"]'
                  >
                    <a
                      class="image-popup"
                      href="assets/images/small/small-4.jpg"
                    >
                      <div
                        class="relative block overflow-hidden rounded group transition-all duration-500"
                      >
                  ...
                  >
                    <a
                      class="image-popup"
                      href="assets/images/small/small-5.jpg"
                    >
                      <div
                        class="relative block overflow-hidden rounded group transition-all duration-500"
                      >
                  ...
                  <div
                    class="xl:w-1/4 lg:w-1/3 p-3 picture-item"
                    data-groups='["digital", "creative"]'
                  >
                    <a
                      class="image-popup"
                      href="assets/images/small/small-6.jpg"
                    >
                      <div
                        class="relative block overflow-hidden rounded group transition-all duration-500"
                      >
                  ...
                  <div
                    class="xl:w-1/4 lg:w-1/3 p-3 picture-item"
                    data-groups='["creative", "digital"]'
                  >
                    <a
                      class="image-popup"
                      href="assets/images/small/small-7.jpg"
                    >
                      <div
                        class="relative block overflow-hidden rounded group transition-all duration-500"
                      >
                  ...
                  >
                    <a
                      class="image-popup"
                      href="assets/images/small/small-8.jpg"
                    >
                      <div
                        class="relative block overflow-hidden rounded group transition-all duration-500"
                      >
              ...
              <div class="p-6">
                ...
                >
                  <img
                    ...
                    src="assets/images/small/plant3.jpg"
                  />
                  <img
                    alt="gallery"
                    class="object-cover object-center rounded"
                  ...
                  <img
                    alt="gallery"
                    class="object-cover object-center rounded"
                    src="assets/images/small/plant2.jpg"
                  />
                  <img
                    alt="gallery"
                    class="object-cover object-center rounded"
                  ...
                  <img
                    alt="gallery"
                    class="object-cover object-center rounded"
                    src="assets/images/small/flower.jpg"
                  />
                  <img
                    alt="gallery"
                    class="object-cover object-center rounded"
            ...
            <div class="card">
              ...
              <div class="p-6">
                ...
                <div class="grid lg:grid-cols-2 grid-cols-1 gap-5">
                  <div
                    class="flex flex-wrap w-full bg-gray-100 py-32 px-10 relative lg:col-span-2"
                  >
                    <img
                      alt="gallery"
              ...
              <div class="p-6">
                ...
                >
                  <div class="flex relative">
                    ...
                    />
                    <div
                      class="px-8 py-10 relative z-10 w-full bg-white opacity-0 hover:opacity-80"
                    >
                      <h2
                        class="tracking-widest text-sm font-semibold text-primary mb-1"
                      >
                        THE SUBTITLE
                      </h2>
                      <h1
            ...
            <div class="card">
              ...
              <div class="p-6">
                <!-- Filter Images -->
                <div
                  class="grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-1 gap-5"
                >
                  <img
                    alt="gallery"
  ...
  <!-- Mirrored from coderthemes.com/konrix/layouts/pages-gallery.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:38 GMT -->
</html>
