<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/extended-lightbox.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:51 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Lightbox | Konrix - Responsive Tailwind Admin Dashboard</title>
        ...
        <main class="flex-grow p-6">
          ...
          <div class="grid grid-cols-1 gap-6">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="singleImageLightbox"
                    >
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="ImageDescriptionLightbox"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
            ...
            <div class="card">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="VideoGalleryLightbox"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
              ...
              <div class="p-6">
                <p class="text-gray-400 mb-4">
                  ...
                  . You can specify a default width for the videos or set
                  different widths to each video in your gallery. The videos are
                  100% responsive and will play correctly on mobile devices.
                </p>
                ...
                <div class="grid lg: grid-cols-3 gap-4">
                  ...
                  <div>
                    <div>
                      <a
                        href="assets/images/lightbox-video.mp4"
                        class="image-popup-video"
                      >
            ...
            <div class="card">
              ...
              <div class="p-6">
                <p class="text-gray-400 mb-4">
                  You can easily add iframes by simply entering the url, it
                  could be a web page, a video, google maps, etc. also you can
                  display any div of your page by entering the ID in the href
                  attribute.
                </p>
  ...
  <!-- Mirrored from coderthemes.com/konrix/layouts/extended-lightbox.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:52 GMT -->
</html>
