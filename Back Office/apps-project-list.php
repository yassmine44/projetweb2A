...
<!-- Mirrored from coderthemes.com/konrix/layouts/apps-project-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:28 GMT -->
<head>
    <meta charset="utf-8">
    <title>Project List | Konrix - Responsive Tailwind Admin Dashboard</title>
                    ...
                    <div class="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
                        <div class="card">
                            ...
                            <div class="flex flex-col">
                                <div class="py-3 px-6">
                                    <h5 class="my-2"><a href="apps-project-detail.php" class="text-slate-900 dark:text-slate-200">Landing page Design</a></h5>
                        ...
                        <div class="card">
                            ...
                            <div class="flex flex-col">
                                <div class="py-3 px-6">
                                    <h5 class="my-2"><a href="apps-project-detail.php" class="text-slate-900 dark:text-slate-200">App Design and Develop</a></h5>
                        ...
                        <div class="card">
                            ...
                            <div class="flex flex-col">
                                <div class="py-3 px-6">
                                    <h5 class="my-2"><a href="apps-project-detail.php" class="text-slate-900 dark:text-slate-200">New Admin Design</a></h5>
                                    <p class="text-gray-500 text-sm mb-9">If several languages coalesce, the grammar of the resulting language is more regular.</p>
                        ...
                        <div class="card">
                            ...
                            <div class="flex flex-col">
                                <div class="py-3 px-6">
                                    <h5 class="my-2"><a href="apps-project-detail.php" class="text-slate-900 dark:text-slate-200">Custom Software Development</a></h5>
                        ...
                        <div class="card">
                            ...
                            <div class="flex flex-col">
                                <div class="py-3 px-6">
                                    <h5 class="my-2"><a href="apps-project-detail.php" class="text-slate-900 dark:text-slate-200">Brand logo design</a></h5>
                        ...
                        <div class="card">
                            ...
                            <div class="flex flex-col">
                                <div class="py-3 px-6">
                                    <h5 class="my-2"><a href="apps-project-detail.php" class="text-slate-900 dark:text-slate-200">Website Redesign</a></h5>
...
<!-- Mirrored from coderthemes.com/konrix/layouts/apps-project-list.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:29 GMT -->
</html>