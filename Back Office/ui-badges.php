...
<!-- Mirrored from coderthemes.com/konrix/layouts/ui-badges.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:40 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="page-content">
            ...
            <main class="flex-grow p-6">
                ...
                <div class="flex justify-between items-center mb-6">
                    <h4 class="text-slate-900 dark:text-slate-200 text-lg font-medium">Badge</h4>
                    ...
                    <div class="md:flex hidden items-center gap-2.5 text-sm font-semibold">
                        ...
                        <div class="flex items-center gap-2">
                            <i class="mgc_right_line text-lg flex-shrink-0 text-slate-400 rtl:rotate-180"></i>
                            <a href="#" class="text-sm font-medium text-slate-700 dark:text-slate-400" aria-current="page">Badge</a>
                        </div>
                    </div>
                </div>
                <!-- Page Title End -->
