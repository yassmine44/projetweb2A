<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/forms-file-uploads.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:45:00 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>File Upload | Konrix - Responsive Tailwind Admin Dashboard</title>
            ...
            <div class="p-6">
              <form action="#" class="dropzone">
                ...
                <div class="dz-message needsclick w-full">
                  <div class="mb-3">
                    <i
                      class="mgc_upload_3_line text-4xl text-gray-300 dark:text-gray-200"
                    ></i>
                  </div>
