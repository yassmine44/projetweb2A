<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/forms-layout.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:45:01 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Form Layout | Konrix - Responsive Tailwind Admin Dashboard</title>
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="HorizontalFormHtml"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
              ...
              <div class="card">
                ...
                <div class="p-6">
                  <p class="text-sm text-slate-700 dark:text-slate-400 mb-4">
                    As shown in the previous examples, our grid system allows
                    you to place any number of a
  ...
  <!-- Mirrored from coderthemes.com/konrix/layouts/forms-layout.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:45:02 GMT -->
</html>
