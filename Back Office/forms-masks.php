<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/forms-masks.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:58 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Form Mask | Konrix - Responsive Tailwind Admin Dashboard</title>
          ...
          <div class="card">
            ...
            <div class="p-6">
              <p class="text-sm text-slate-700 dark:text-slate-400 mb-4">
                A Java-Script Plugin to make masks on form fields and HTML
                elements.
              </p>
                  ...
                  <form action="#">
                    <div class="mb-3">
                      ...
                      <p class="text-xs mt-1">
                        ...
                        <code class="text-primary"
                          >data-toggle="input-mask"
                          data-mask-format="00/00/0000"</code
                        >
                      </p>
                    </div>
                    <div class="mb-3">
                      ...
                      <p class="text-xs mt-1">
                        ...
                        <code class="text-primary"
                          >data-toggle="input-mask"
                          data-mask-format="00:00:00"</code
                        >
                      </p>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <p class="text-xs mt-1">
                        ...
                        <code class="text-primary"
                          >data-toggle="input-mask"
                          data-mask-format="00000-000"</code
                        >
                      </p>
                    </div>
                    <div class="mb-3">
                      ...
                      <p class="text-xs mt-1">
                        ...
                        <code class="text-primary"
                          >data-toggle="input-mask"
                          data-mask-format="0-00-00-00"</code
                        >
                      </p>
                    </div>
                    <div class="mb-3">
                  ...
                  <form action="#">
                    <div class="mb-3">
                      ...
                      <p class="text-xs mt-1">
                        ...
                        <code class="text-primary"
                          >data-toggle="input-mask"
                          data-mask-format="0000-0000"</code
                        >
                      </p>
                    </div>
                    <div class="mb-3">
