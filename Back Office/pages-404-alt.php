<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/pages-404-alt.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:38 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>
      Error Page | 404 Atl | Konrix - Responsive Tailwind Admin Dashboard
    </title>
        ...
        <main class="flex-grow p-6">
          ...
          <div class="flex h-full justify-center items-center">
            <div class="flex flex-col justify-center text-center gap-6">
              ...
              <a href="index.php" class="text-base font-medium text-primary">
                Go back home
              </a>
            </div>
          </div>
