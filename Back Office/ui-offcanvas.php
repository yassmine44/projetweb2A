<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/ui-offcanvas.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:41 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>offcanvas | Konrix - Responsive Tailwind Admin Dashboard</title>
            ...
            <div class="card">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="PositionsOffcanvasHtml"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
              ...
              <div class="p-6">
                <div class="flex flex-wrap gap-4">
                  ...
                  <div
                    class="fc-offcanvas-open:translate-x-0 translate-x-full fixed top-0 right-0 transition-all duration-300 transform h-full max-w-xs w-full z-50 bg-white border-l dark:bg-gray-800 dark:border-gray-700 hidden"
                  >
                    <div
                      class="flex justify-between items-center py-2 px-4 border-b dark:border-gray-700"
                    >
  ...
  <!-- Mirrored from coderthemes.com/konrix/layouts/ui-offcanvas.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:42 GMT -->
</html>
