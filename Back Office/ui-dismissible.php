<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/ui-dismissible.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:41 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Dismissable | Konrix - Responsive Tailwind Admin Dashboard</title>
        ...
        <main class="flex-grow p-6">
          ...
          <div class="grid lg:grid-cols-2 grid-cols-1 gap-6">
                ...
                <div class="p-6">
                  ...
                  >
                    <p>
                      ...
                      You can dismiss this alert by, simply click on close
                      button
                    </p>
                    <button
                      class="flex-shrink-0"
                      data-fc-dismiss="dismiss-example"
                      type="button"
                    >
            ...
            <div class="card">
              ...
              <div class="p-6">
                <div
                  class="card shadow-md max-w-xs relative transition-all duration-300"
                  id="dismiss-card"
                >
                  <div class="absolute end-2 top-2">
                    <button
                      data-fc-dismiss="dismiss-card"
                      type="button"
                      id="dismiss-test"
