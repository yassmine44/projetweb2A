<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/docs-installation.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:45:10 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Installation | Konrix - Responsive Tailwind Admin Dashboard</title>
      ...
      <div class="page-content">
        ...
        <main class="flex-grow p-6">
          ...
          <div class="card">
            ...
            <div class="p-6">
              <div
                class="bg-success/20 text-sm text-success rounded-md p-4"
                role="alert"
              >
                <p>
                  <strong>Note:</strong> You could use the ready-to-use
                  (pre-compiled) demos available in the
                  <code>dist</code> folder, if you are not looking for any
              ...
              <div class="p-6 max-w-full">
                <p class="mt-3">
                  ...
                  <a
                    ...
                    >gulp</a
                  >
                  which allows to have complete automatation for build flow. In
                  case if you don't know - Gulp is a toolkit for automating
                  painful or time-consuming tasks in development workflow, so
                  you can stop messing around and build something. You can read
                  it more about it
                  <a
                    href="https://gulpjs.com/"
                    target="_blank"
                ...
                <h6 class="mt-9 mb-2.5 text-base font-semibold">
                  Prerequisites
                </h6>
                ...
                <ul class="ps-8">
                  <li class="list-disc">
                    ...
                    <p class="mb-3.5">
                      In order to use build tools you will need to download and
                      install Node.js. If you do not have Node.js installed
                      already, you can get it by downloading the package
                      installer from the official website. Please download the
                      stable version of Node.js (LTS).
                    </p>
                    <a
                  ...
                  <li class="pt-2 list-disc">
                    ...
                    <p>
                      ...
                      <code>npm install -g gulp@4.0.1</code> from your terminal.
                    </p>
                  </li>
                  <li class="list-disc">
                  ...
                  <li class="list-disc">
                    ...
                    <p>
                      ...
                      >
                      installed &amp; running in your computer. If you already
                      have installed git on your computer, you can skip this
                      step
                    </p>
                  </li>
                </ul>
                ...
                <p class="mb-1">
                  ...
                  <code>yarn install</code>. This would install all required
                  dependencies in <code>node_modules</code> folder. And now, you
                  are ready to run the Konrix for the first time.
                </p>
                <p class="mb-4">
                ...
                <div
                  class="shadow-sm overflow-hidden ring-1 ring-gray-200 dark:ring-gray-700 rounded-md"
                >
                  <table
                  ...
                  >
                    ...
                    >
                      <tr>
                        <td
                          class="px-6 py-4 text-sm whitespace-nowrap font-medium"
                        >
                          <code>gulp</code>
                        </td>
                        <td
                        ...
                        >
                          Runs demo locally, starts the development server and
                          watches for any changes in your code, including your
                      ...
                      <tr>
                        ...
                        <td
                          class="px-6 py-4 text-sm font-medium text-gray-800 dark:text-gray-200"
                        >
                          It compiles the source assets including scss and
                          bundles into production ready use.
                        </td>
                      </tr>
                    </tbody>
                  </table>
                ...
                <div class="mt-6">
                  <p class="mb-3.5 font-semibold">Troubleshooting</p>
                  <ul class="ps-8">
                    <li class="list-disc">
                      I am getting error "<code
                        >Error: ENOENT: no such file or directory, scandir
                        '/root/website/node_modules/node-sass/vendor'</code
                      >" while running npm install, what should I do?
                      <p class="mb-4">
                        If you are getting this error, there could be multiple
                        root causes, please try following workarounds:
                      </p>
                      <ul class="ps-8">
                        <li>
              ...
              <div class="bg-success/20 text-sm text-success rounded-md p-4">
                If you are having any question or difficulty during setup, don't
                hesitate to contact us. We would be glad to assist you.
              </div>
            </div>
          </div>
        </main>
