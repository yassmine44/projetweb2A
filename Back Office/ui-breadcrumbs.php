...
<!-- Mirrored from coderthemes.com/konrix/layouts/ui-breadcrumbs.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:40 GMT -->
<head>
    <meta charset="utf-8">
    <title>Breadcrumb | Konrix - Responsive Tailwind Admin Dashboard</title>
        ...
        <div class="page-content">
            ...
            <main class="flex-grow p-6">
                ...
                <div class="flex justify-between items-center mb-6">
                    <h4 class="text-slate-900 dark:text-slate-200 text-lg font-medium">Breadcrumb</h4>
