<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/tables-datatables.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:45:02 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Data Table | Konrix - Responsive Tailwind Admin Dashboard</title>
        ...
        <main class="flex-grow p-6">
          ...
          <div class="flex flex-col gap-6">
            ...
            <div class="card">
              ...
              <div class="p-6">
                <p class="text-sm text-slate-700 dark:text-slate-400 mb-4">
                  Grid.js renders a loading bar automatically while it waits for
                  the data to be fetched. Here we are using an async function to
                  demonstrate this behaviour (e.g. an async function can be a
                  XHR call to a server backend)
                </p>
            ...
            <div class="card">
              ...
              <div class="p-6">
                <p class="text-sm text-slate-700 dark:text-slate-400 mb-4">
                  Add <code>hidden: true</code> to the columns definition to
                  hide them.
                </p>
  ...
  <!-- Mirrored from coderthemes.com/konrix/layouts/tables-datatables.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:45:03 GMT -->
</html>
