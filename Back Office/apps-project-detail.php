<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/apps-project-detail.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:29 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Project Detail | Konrix - Responsive Tailwind Admin Dashboard</title>
                  ...
                  <div>
                    ...
                    <div class="grid grid-cols-4 gap-6">
                      ...
                      <div class="">
                        <p class="mb-3 text-sm uppercase font-medium">
                          <i
                            class="uil-calendar-slash text-red-500 text-base"
                          ></i>
                          Due Date
                        </p>
                        <h5
                    ...
                    <div class="mt-6">
                      <h6 class="text-gray-800 font-medium mb-3">
                        Attached Files
                      </h6>
                  ...
                  >
                      ...
                      <div class="flex items-center gap-3">
                        ...
                        <div class="flex-grow truncate">
                          ...
                          <p class="text-gray-600 dark:text-gray-400">
                            jameswalton@gmail.com
                          </p>
                        </div>
                        <div
                          class="px-3 py-1 md:block hidden rounded text-xs font-medium"
                        >
                          Wire Frame
                        </div>
                        <div class="ms-auto">
                          <div
                            class="px-3 py-1 rounded text-xs font-medium bg-primary/25 text-primary"
                          >
                            Working
                          </div>
                        </div>
                    ...
                    <div class="p-3">
                      <div class="flex items-center gap-3">
                        ...
                        <div class="ms-auto">
                          <div
                            class="px-3 py-1 rounded text-xs font-medium bg-success/25 text-success"
                          >
                            Complated
                          </div>
                        </div>
                    ...
                    <div class="p-3">
                      <div class="flex items-center gap-3">
                        ...
                        <div class="ms-auto">
                          <div
                            class="px-3 py-1 rounded text-xs font-medium bg-danger/25 text-danger"
                          >
                            Stop
                          </div>
                        </div>
