<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/ui-modals.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:41 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Modal | Konrix - Responsive Tailwind Admin Dashboard</title>
          ...
          <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
            ...
            <div class="card">
              ...
              <div class="p-6">
                ...
                <div
                  id="Slide_Down_Animation_Modal_Html"
                  class="hidden w-full overflow-hidden transition-[height] duration-300"
                >
                  <pre class="language-html h-56">
                                    <code>
            ...
            <div class="card">
              ...
              <div class="p-6">
                <div class="flex flex-wrap gap-4">
                  ...
                  >
                    <div
                      class="sm:max-w-sm fc-modal-open:opacity-100 duration-500 opacity-0 ease-out transition-all sm:w-full m-3 sm:mx-auto flex flex-col bg-white border shadow-sm rounded-md dark:bg-slate-800 dark:border-gray-700"
                    >
                      <div
                        class="flex justify-between items-center py-2.5 px-4 border-b dark:border-gray-700"
                      >
                  ...
                  >
                    <div
                      class="sm:max-w-md fc-modal-open:opacity-100 duration-500 opacity-0 ease-out transition-all sm:w-full m-3 sm:mx-auto flex flex-col bg-white border shadow-sm rounded-md dark:bg-slate-800 dark:border-gray-700"
                    >
                      <div
                        class="flex justify-between items-center py-2.5 px-4 border-b dark:border-gray-700"
                      >
                  ...
                  >
                    ...
                    >
                      <div class="flex justify-between items-center">
                        <h3
                          class="font-medium text-gray-800 dark:text-white text-2xl"
                        >
                          Modal Title
                        </h3>
                        <button
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="CenterdModalHtml"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
