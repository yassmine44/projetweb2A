...
// Utiliser la classe entrepriseE
$c = new entrepriseE();
...
<body>
    <a href="../View/back/table-dattable-basic.php" class="btn btn-primary">Afficher la liste user</a><br>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="deleteE.php?identreprise=<?php echo $entreprise['identreprise']; ?>"class="text-danger">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
