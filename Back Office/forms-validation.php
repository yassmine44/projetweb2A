<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/forms-validation.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:45:00 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Validation | Konrix - Responsive Tailwind Admin Dashboard</title>
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="browserDefaultsValidation"
                    >
              ...
              <div class="p-6">
                <form class="grid lg:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <div class="flex items-center">
                      <span
                        class="py-2 px-3 bg-light rounded-l"
            ...
            <div class="card">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="pristineJSValidation"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
              ...
              <div class="p-6">
                <p class="text-gray-400 text-sm mb-4">
                  Three part must included
                  <code>.form-valid, .form-group and required</code> element.
  ...
  <!-- Mirrored from coderthemes.com/konrix/layouts/forms-validation.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:45:01 GMT -->
</html>
