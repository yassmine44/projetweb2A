<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/docs-changelog.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:45:10 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Changelog | Konrix - Responsive Tailwind Admin Dashboard</title>
          ...
          <div class="card">
            <div class="p-6">
              ...
              <ul class="list-inside">
                <li
                  class="text-sm text-slate-700 dark:text-slate-400 list-disc"
                >
                  Initial released
                </li>
              </ul>
