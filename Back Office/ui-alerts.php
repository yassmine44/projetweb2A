<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/ui-alerts.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:40 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Alerts | Konrix - Responsive Tailwind Admin Dashboard</title>
          ...
          <div class="grid 2xl:grid-cols-2 grid-cols-1 gap-6">
            <div class="card">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="alertHeadingHtml"
                    >
              ...
              <div class="p-6">
                <div class="space-y-4">
                  <div
                    class="bg-primary text-sm text-white rounded-md p-4"
                    role="alert"
                  >
                    <span class="font-bold">Primary</span> alert! You should
                    check in on some of those fields below.
                  </div>
                  <div
                    class="bg-secondary text-sm text-white rounded-md p-4"
                    role="alert"
                  >
                    <span class="font-bold">Secondary</span> alert! You should
                    check in on some of those fields below.
                  </div>
                  <div
                    class="bg-info text-sm text-white rounded-md p-4"
                    role="alert"
                  >
                    <span class="font-bold">Info</span> alert! You should check
                    in on some of those fields below.
                  </div>
                  <div
                    class="bg-success text-sm text-white rounded-md p-4"
                    role="alert"
                  >
                    <span class="font-bold">Success</span> alert! You should
                    check in on some of those fields below.
                  </div>
                  <div
                    class="bg-danger text-sm text-white rounded-md p-4"
                    role="alert"
                  >
                    <span class="font-bold">Danger</span> alert! You should
                    check in on some of those fields below.
                  </div>
                  <div
                    class="bg-warning text-sm text-white rounded-md p-4"
                    role="alert"
                  >
                    <span class="font-bold">Warning</span> alert! You should
                    check in on some of those fields below.
                  </div>
                  <div
                    class="bg-dark text-sm text-white rounded-md p-4"
                    role="alert"
                  >
                    <span class="font-bold">Dark</span> alert! You should check
                    in on some of those fields below.
                  </div>
                </div>
            ...
            <div class="card">
              ...
              <div class="p-6">
                <div class="space-y-4">
                  <div
                    class="bg-primary/25 text-primary text-sm rounded-md p-4"
                    role="alert"
                  >
                    <span class="font-bold">Primary</span> alert! You should
                    check in on some of those fields below.
                  ...
                  <div
                    class="bg-secondary/25 text-secondary text-sm rounded-md p-4"
                    role="alert"
                  >
                    <span class="font-bold">Secondary</span> alert! You should
                    check in on some of those fields below.
                  ...
                  <div
                    class="bg-info/25 text-info text-sm rounded-md p-4"
                    role="alert"
                  >
                    <span class="font-bold">Info</span> alert! You should check
                    in on some of those fields below.
                  ...
                  <div
                    class="bg-success/25 text-success text-sm rounded-md p-4"
                    role="alert"
                  >
                    <span class="font-bold">Success</span> alert! You should
                    check in on some of those fields below.
                  ...
                  <div
                    class="bg-danger/25 text-danger text-sm rounded-md p-4"
                    role="alert"
                  >
                    <span class="font-bold">Danger</span> alert! You should
                    check in on some of those fields below.
                  ...
                  <div
                    class="bg-warning/25 text-warning text-sm rounded-md p-4"
                    role="alert"
                  >
                    <span class="font-bold">Warning</span> alert! You should
                    check in on some of those fields below.
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="alertDescriptionHtml"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
            ...
            <div class="card">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="alertActionsHtml"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
              ...
              <div class="p-6">
                <div
                  class="bg-sky-50 border border-sky-200 rounded-md p-4"
                  role="alert"
                >
                  <div class="flex">
                    <div class="flex-shrink-0">
                    ...
                    <div class="ms-4">
                      ...
                      <div class="mt-2 text-sm text-gray-600">
                        Notifications may include alerts, sounds and icon
            ...
            <div class="card">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="alertDismissHtml"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
              ...
              <div class="p-6">
                <div
                  id="dismiss-alert"
                  class="transition duration-300 bg-teal-50 border border-teal-200 rounded-md p-4"
                  role="alert"
                >
