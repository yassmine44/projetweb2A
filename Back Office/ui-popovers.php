<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/ui-popovers.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:42 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Popover | Konrix - Responsive Tailwind Admin Dashboard</title>
            ...
            <div class="card">
              ...
              <div class="p-6">
                <button
                  ...
                  data-fc-target="default-tooltip"
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="#autoTargetingPopover"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="#withDirectionPopover"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
              ...
              <div class="p-6">
                <div class="flex flex-wrap gap-3">
                  <div>
                    ...
                    <div
                      class="bg-gray-400 hidden px-3 py-1 rounded-md transition-all text-white opacity-0 z-50"
                    >
                      Top popover
                      <div
                        data-fc-arrow
                        class="bg-gray-400 w-2.5 h-2.5 rotate-45 -z-10 rounded-[1px]"
                      ></div>
                    </div>
                  </div>
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="#withContentPopover"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
                ...
                <div class="flex flex-wrap gap-3">
                  <div>
                    ...
                    <div class="w-72 hidden z-50">
                      ...
                      ></div>
                      <div
                        class="bg-white border border-gray-100 dark:bg-gray-800 dark:border-gray-700"
                      >
                  ...
                  <div>
                    ...
                    <div class="hidden z-50">
                      ...
                      >
                        <span
                          class="pt-3 px-4 block text-lg font-bold text-gray-800 dark:text-white"
                          >Overview</span
                        >
                        <div
                        ...
                        >
                          ...
                          />
                          <p>
                            This is a popover body with supporting text below as
