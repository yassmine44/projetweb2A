<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/apps-tickets.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:27 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Tickets | Konrix - Responsive Tailwind Admin Dashboard</title>
      ...
      <div class="page-content">
        ...
        <main class="flex-grow p-6">
          ...
          <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-6">
            ...
            <div class="card">
              <div class="p-5">
                <div class="flex justify-between">
                  <div
                    class="w-20 h-20 rounded-full inline-flex items-center justify-center bg-yellow-100"
                  >
          ...
          <div class="mt-6">
            <div class="card">
              <div
                class="flex flex-wrap justify-between items-center gap-2 p-6"
              >
                <a
                  href="javascript:void(0);"
              ...
              <div class="relative overflow-x-auto">
                <table
                  class="w-full divide-y divide-gray-300 dark:divide-gray-700"
                >
                  <thead
                  ...
                  <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    <tr>
                      ...
                      >
                        <div
                          class="inline-flex items-center gap-1.5 py-1 px-3 rounded text-xs font-medium bg-primary/25 text-primary"
                        >
                          Medium
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        <div
                          class="inline-flex items-center gap-1.5 py-1 px-3 rounded text-xs font-medium bg-danger/25 text-danger"
                        >
                          High
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      >
                        <div
                          class="inline-flex items-center gap-1.5 py-1 px-3 rounded text-xs font-medium bg-dark/25 text-slate-900 dark:text-slate-200/90"
                        >
                          Low
                        </div>
                      </td>
                      ...
                      >
                        <div
                          class="inline-flex items-center gap-1.5 py-1 px-3 rounded text-xs font-medium bg-success/90 text-white"
                        >
                          Open
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td
                        class="whitespace-nowrap py-4 pe-3 text-sm font-medium text-gray-900 dark:text-gray-200"
                      >
                        Question regarding your Tailwind Theme
                      </td>
                      <td class="whitespace-nowrap py-4 px-3 text-sm">
                        <img
                          class="h-10 w-10 rounded-full"
  ...
  <!-- Mirrored from coderthemes.com/konrix/layouts/apps-tickets.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:28 GMT -->
</html>
