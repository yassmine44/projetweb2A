<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/apps-kanban.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:28 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Kanban | Konrix - Responsive Tailwind Admin Dashboard</title>
                  ...
                  >
                    <div class="card p-4 cursor-pointer">
                      <div class="flex justify-between items-center">
                        <h4
                          class="flex justify-between items-center h-6 px-3 text-xs font-semibold text-danger bg-danger/25 rounded-full"
                        >
                          Design
                        </h4>
                      ...
                      >
                        ...
                        <div class="flex items-center ms-4">
                          <i
                            class="mgc_attachment_line rotate-45 text-base"
                          ></i>
                          <span class="ms-1 leading-none">12</span>
                        </div>
                        <img
                          class="w-6 h-6 ms-auto rounded-full"
                    ...
                    <div class="card p-4 cursor-pointer">
                      <div class="flex justify-between items-center">
                        <h4
                          class="flex justify-between items-center h-6 px-3 text-xs font-semibold text-gray-400 bg-gray-400/25 rounded-full"
                        >
                          Web
                        </h4>
                ...
                >
                  ...
                  >
                    <div class="card p-4 cursor-pointer">
                      <div class="flex justify-between items-center">
                        <h4
                          class="flex justify-between items-center h-6 px-3 text-xs font-semibold text-info bg-info/25 rounded-full"
                        >
                          Product
                        </h4>
                    ...
                    <div class="card p-4 cursor-pointer">
                      <div class="flex justify-between items-center">
                        <h4
                          class="flex justify-between items-center h-6 px-3 text-xs font-semibold text-cyan-500 bg-cyan-500/25 rounded-full"
                        >
                          Checking
                        </h4>
                    ...
                    <div class="card p-4 cursor-pointer">
                      <div class="flex justify-between items-center">
                        <h4
                          class="flex justify-between items-center h-6 px-3 text-xs font-semibold text-warning bg-warning/25 rounded-full"
                        >
                          Shopify
                        </h4>
                ...
                >
                  ...
                  >
                    <div class="card p-4 cursor-pointer">
                      <div class="flex justify-between items-center">
                        <h4
                          class="flex justify-between items-center h-6 px-3 text-xs font-semibold text-sky-500 bg-sky-500/25 rounded-full"
                        >
                          App
                        </h4>
                ...
                >
                  ...
                  >
                    ...
                    <div class="card p-4 cursor-pointer">
                      <div class="flex justify-between items-center">
                        <h4
                          class="flex justify-between items-center h-6 px-3 text-xs font-semibold text-amber-500 bg-amber-500/25 rounded-full"
                        >
                          Testing
                        </h4>
                ...
                >
                  ...
                  >
                    <div class="card p-4 cursor-pointer">
                      <div class="flex justify-between items-center">
                        <h4
                          class="flex justify-between items-center h-6 px-3 text-xs font-semibold text-pink-500 bg-pink-500/25 rounded-full"
                        >
                          Q&A
                        </h4>
