<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/forms-pickers.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:55 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Picker | Konrix - Responsive Tailwind Admin Dashboard</title>
    ...
    <link
      rel="stylesheet"
      href="assets/libs/%40simonwep/pickr/themes/classic.min.css"
    />
    <!-- 'classic' theme -->
    <link
      rel="stylesheet"
      href="assets/libs/%40simonwep/pickr/themes/monolith.min.css"
    />
    <!-- 'monolith' theme -->
    <link
      rel="stylesheet"
      href="assets/libs/%40simonwep/pickr/themes/nano.min.css"
    />
    <!-- 'nano' theme -->
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="BasicPickerHtml"
                    >
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="DateTimePickerHtml"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
                ...
                <div class="flex justify-between items-center">
                  ...
                  <div class="flex items-center gap-2">
                    <button
                      ...
                      class="btn-code"
                      data-fc-type="collapse"
                      data-fc-target="MinMaxPickerHtml"
                    >
                      <i class="mgc_eye_line text-lg"></i>
                      <span class="ms-2">Code</span>
                    </button>
                  ...
                  <div>
                    ...
                    <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-6">
                      <div class="bg-slate-100 p-4 rounded-md flex flex-col">
                        <h5 class="text-base text-gray-400 mb-2 shrink-0">
                          Classic Demo
                        </h5>
                  ...
                  <div class="mt-5">
                    ...
                    <div class="grid lg:grid-cols-5 md:grid-cols-3 gap-6">
                      ...
                      <div class="bg-slate-100 p-4 rounded-md flex flex-col">
                        ...
                        <p class="text-gray-400 grow">
                          Use <code>colorpicker-switch</code> class to set
                          switch colorpicker.
                        </p>
  ...
  <!-- Mirrored from coderthemes.com/konrix/layouts/forms-pickers.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:58 GMT -->
</html>
