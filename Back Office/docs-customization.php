<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/docs-customization.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:45:10 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Customization | Konrix - Responsive Tailwind Admin Dashboard</title>
        ...
        <main class="flex-grow p-6">
          ...
          <div class="flex flex-col gap-6">
            <div class="card">
              ...
              <div class="p-6">
                <p>
                  You can change the colour palatte of any demo very easily by
                  simply changing the few SCSS variables' value.
                </p>
                ...
                <p>
                  ...
                  reflected automatically in any Tailwind based components or
                  elements. Note that, this requires you to setup and run gulp
                  flow provided in installation steps earlier.
                </p>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div class="p-6">
                <p>
                  Konrix provides the RTL support as well. You will simply add
                  attribute in html tage.
                </p>
                <p>
                  simply change the reference of update the html tag with
                  attribute <code>dir="rtl"</code>. E.g.
                  <code
                    >&lt;html lang=&quot;en&quot; dir=&quot;rtl&quot;&gt;</code
                  >
                </p>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div class="p-6">
                <p class="mb-4">
                  ...
                  layout width or right sidebar. You could turn the left sidebar
                  to different size, theme (look) and type. You can customize it
                  by specifying the layout config data attribute on
                  <code>html</code> element in your html
                </p>

                <div
                  class="overflow-hidden ring-1 ring-gray-200 dark:ring-gray-700 md:rounded-lg mb-6"
                >
                  <table
                    ...
                    >
                      ...
                      <tr>
                        ...
                        <td
                          class="whitespace-nowrap px-3 py-4 text-sm text-gray-800 dark:text-gray-200"
                        >
                          "default" | "md" | "sm" | "hover" | "hover-active" |
                          "mobile" | "hidden"
                        </td>
                        <td
                          class="whitespace-nowrap px-3 py-4 text-sm text-gray-800 dark:text-gray-200"
                ...
                <ul class="list-disc ms-4">
                  <li>
                    ...
                    <code
                      >&lt;html data-menu-color="dark"&gt;&lt;/html&gt;</code
                    >
                  </li>
                  <li>
                    <h5 class="my-2">
                    ...
                    <code
                      >&lt;html data-menu-color="light"&gt;&lt;/html&gt;</code
                    >
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <code
                      >&lt;html data-sidenav-view="sm"&gt;&lt;/html&gt;</code
                    >
                  </li>
                </ul>
              </div>
            ...
            <div class="card">
              ...
              <div class="p-6">
                <p>
                  ...
                  <code>src/pages-starter.php</code>). It allows you to get
                  started easily and helps you to add new page. Please note
                  following important points:
                </p>
                <ul>
                  <li>
                    Most of default/basic form elements along with few advanced
                    elements are separately add css and js.
                  </li>
                  <li>
                    Few elements e.g. charts, data tables, calendar, maps etc
                    requires you to include corresponding css and js files in
                    your html. Please check corresponding documentation page for
                    the same.
                  </li>
                </ul>
              </div>
