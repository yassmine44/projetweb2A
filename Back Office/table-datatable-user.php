<?php
require_once 'C:/Users/Administrateur/Desktop/Test/us/Controller/user.php';


// Utiliser la classe userE
$c = new user();
$tab = $c->listeruser();

if (isset($_GET['idd'])) {
	$c = new user();
	$c->supprimeruser($_GET["idd"]);
  }
  if (isset($_GET['idb'])) {
  
	$c = new user();
	$donnee = $c->getUserById($_GET['idb']);
	$c->updateusera($_GET["idb"],$donnee['prenom'],$donnee['nom'],$donnee['age'],$donnee['email'],$donnee['mdp'],$donnee['fonction'],"ban");
	
  }
  if (isset($_GET['idub'])) {
  
	$c = new user();
	$donnee = $c->getUserById($_GET['idub']);
	$c->updateusera($_GET["idub"],$donnee['prenom'],$donnee['nom'],$donnee['age'],$donnee['email'],$donnee['mdp'],$donnee['fonction'],"actif");
...
<body>
    <a href="../View/back/table-dattable-user.php" class="btn btn-primary">Afficher la liste user</a><br>
    ...
    ***********************************-->
    <div id="main-wrapper">
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="table-datatable-entretien.php">liste des entretiens</a></li>
							<li><a href="table-datatable-basic.php">liste des entreprises</a></li>
                            <li><a href="table-datatable-user.php">users</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
														<?php
														echo "<a href='updateuser.php?id=" . $user['id'] . "' class='bg-green-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded ml-2'><span style='color:black;'>Update</span></a>";
														?>
                                                       
                                                    </td>
                                                    <td>
                                                        <?php
														echo "<a href='table-datatable-user.php?idd=" . $user['id'] . "' class='bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded ml-2'><span style='color:black;'>delete</span></a>";
														?>
                                                    </td>
													<td>
														<?php
                    										 echo "<a href='table-datatable-user.php?idb=" . $user['id'] . "' class='bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-1 px-2 rounded ml-2'><span style='color:black;'>Ban User</span></a>";
														?>
													</td>
													<td>
                                                        <?php
														echo "<a href='table-datatable-user.php?idub=" . $user['id'] . "' class='bg-green-500 hover:bg-yellow-700 text-white font-bold py-1 px-2 rounded ml-2'><span style='color:black;'>UnBan User</span></a>";
														?>
                                                    </td>
                                                </tr>
                                            <?php
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="../index.html" target="_blank">DexignLab</a> 2021</p>
            </div>
        </div>
        <!--**********************************
            Footer end
