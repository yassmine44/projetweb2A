<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/extended-tour.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:50 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>Tour Page | Konrix - Responsive Tailwind Admin Dashboard</title>
            ...
            <div class="p-6">
              <div class="">
                <div class="text-center mb-6">
                  <div
                    class="inline-flex justify-center py-3 px-2"
                    id="logo-tour"
                  >
                    <img
                      src="assets/images/logo-dark.png"
                ...
                <div
                  class="grid sm:grid-cols-2 lg:grid-cols-4 items-center gap-6"
                >
                  <div class="p-6" id="tour-card-one">
                    <i
                      class="mgc_cellphone_line text-4xl text-gray-800 dark:text-white"
                    ></i>
                    <div
                  ...
                  <div class="p-6" id="tour-card-two">
                    <i
                      class="mgc_settings_2_line text-4xl text-gray-800 dark:text-white"
                    ></i>
                    <div
                      class="bg-gradient-to-r from-gray-200 to-white/0 h-0.5 mt-6 dark:from-gray-700 dark:to-slate-900/0"
                    >
                  ...
                  <div class="p-6" id="tour-card-three">
                    <i
                      class="mgc_document_2_line text-4xl text-gray-800 dark:text-white"
                    ></i>
                    <div
                      class="bg-gradient-to-r from-gray-200 to-white/0 h-0.5 mt-6 dark:from-gray-700 dark:to-slate-900/0"
                    >
                  ...
                  <div class="p-6" id="tour-card-four">
                    <div
                      class="mgc_message_2_line text-4xl text-gray-800 dark:text-white"
                    ></div>
                    <div
                      class="bg-gradient-to-r from-gray-200 to-white/0 h-0.5 mt-6 dark:from-gray-700 dark:to-slate-900/0"
                    >
                ...
                <div class="text-center mt-8">
                  <button class="btn bg-success text-white" id="thankyou-tour">
                    Thank you !
                  </button>
                </div>
              </div>
...
tour.start();
  ...
  <!-- Mirrored from coderthemes.com/konrix/layouts/extended-tour.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:51 GMT -->
</html>
