...
<html lang="en">
  <!-- Mirrored from coderthemes.com/konrix/layouts/apps-file-manager.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Mar 2024 19:44:28 GMT -->
  <head>
    <meta charset="utf-8" />
    <title>File Manager | Konrix - Responsive Tailwind Admin Dashboard</title>
      ...
      <div class="page-content">
        ...
        <main class="flex-grow p-6">
          ...
          <div class="flex">
            ...
            >
              <div class="p-5">
                <div class="relative">
                  ...
                  <div
                    class="fc-dropdown fc-dropdown-open:opacity-100 opacity-0 w-full z-50 transition-all duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-lg p-2 hidden"
                  >
                    <a
                ...
                <div class="space-y-2 mt-4">
                  <a
                    href="javascript:void(0);"
                    class="flex items-center py-2 px-4 text-sm rounded text-gray-500 bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:bg-gray-700 dark:hover:text-gray-300"
                    id="headingOne"
                  >
            ...
            <div class="w-full">
              <div
                class="grid 2xl:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-6"
              >
