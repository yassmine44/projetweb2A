...
// Vérifier si le formulaire est soumis
    ...
    if (
    ...
    )
     {
        ...
        if (
            ...
            // Créer un objet entretien avec les données du formulaire
            $entretien = new entretien(
                $_POST['IDE'], // L'ID sera auto-incrémenté, donc vous pouvez passer null ici
                $_POST['nom'],
                $_POST['email'],
                $_POST['titreposte'],
                $_POST['daterdv'],
            ...
            header('Location:listeentretien.php');
            exit();
        } else 
    ...
    <html lang="en">
        ...
        <body>
            ...
            <!-- entretien Start -->
            <div class="container">
                <h1>Prise de rendez-vous - JOBFLEX</h1>
                <form action="" method="POST">
                    <table>
                         <tr>
                            <td><label for="IDE">IDE :</label></td>
                            <td>
                                <input type="text" id="IDE" name="IDE" />
                                <span id="erreurIDE" style="color: red"></span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><label for="titreposte">titreposte :</label></td>
                            <td>
                                <input type="text" id="titreposte" name="titreposte" />
                                <span id="erreurtitreposte" style="color: red"></span>
                            </td>
                        </tr>
                        <tr>
                           <td><label for="daterdv">Date du rendez-vous :</label></td>
                           <td>
                                <select id="daterdv" name="daterdv">
                                        <option value="2024-05-01">01/05/2024</option>
                                        <option value="2024-05-03">03/05/2024</option>
                                        <option value="2024-05-06">06/05/2024</option>
                                        <option value="2024-05-13">13/05/2024</option>
                                </select>
                          </td>
                                <td><span id="erreurdaterdv" style="color: red"></span></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span id="erreurformat" style="color: red"></span>
                            </td>
                        </tr>
                        <tr>
