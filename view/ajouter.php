...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div>
                ...
                <div>
                    <label for="langue">Langue de l'entretien :</label>
                ...
                <div>
                    <label for="format">Format de l'entretien :</label>
    ...
    <!-- Champs du formulaire pour confirmer le rendez-vous -->
    <button type="submit" name="confirmer_entretien">Confirmer le rendez-vous</button>
</form>
