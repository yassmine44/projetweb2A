...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="condidatlist.php">Liste Des Candidats</a></li>
                                    ...
                                    <li><a href="postlist.php">Listes Des posts D'emploi</a></li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="afficherof.php">Afficher Les posts</a></li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="empty-page.php">Ajout D'Un post</a></li>
				...
				<div class="side-bar-profile">
					<div class="d-flex align-items-center justify-content-between mb-3">
						...
						<div class="profile-info1">
							...
							<span>mohamedaziz.cherif.1@esprit.tn</span>
						</div>
				...
				<div class="copyright">
					...
					<p class="fs-12">Made with <span class="heart"></span> by JOB FLEX TEAM</p>
				</div>
			</div>
        </div>
        <!--**********************************
				...
				<div class="main-panel">
					<div class="content-wrapper">
						...
						<div class="col-12 grid-margin">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">Ajout d'un post</h4>
									<div id="error">
										<?php echo $error; ?>
									</div>
									<form class="form-sample" action="" method="POST" onsubmit="return verif()">
											...
											<div class="col-md-6">
												<div class="form-group row">
													<label class="col-sm-3 col-form-label">Date De L'post</label>
													<div class="col-sm-9">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group row">
													<label class="col-sm-3 col-form-label">image d'post</label>
													<div class="col-sm-9">
														<input id="img" name="img" type="img" class="form-control">
													</div>
												</div>
											</div>
										</div>
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by Job Flex Team <a href="../index.htm" target="_blank">JOBFLEX</a> 2024</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
	...
	<script>
    function verif() {
        let titrepost = document.getElementById("titrepost").value.trim();
        ...
        if (titrepost === "") {
            alert("Veuillez saisir le titre de l'post.");
            return false;
        }

        // Check if titrepost contains only uppercase letters
        if (!uppercaseRegex.test(titrepost)) {
            alert("Votre titre de l'post doit contenir uniquement des lettres majuscules.");
            return false;
        }
        ...
        // Check if date is positive
        if (parseFloat(date) <= 0 || isNaN(parseFloat(date))) {
            alert("Le date doit être un nombre positif.");
            return false;
        }
