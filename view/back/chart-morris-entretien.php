<?php
include_once "C:/xampp/htdocs/gestionentretien/Controller/entretienC.php";
include_once "C:/xampp/htdocs/gestionentretien/Model/entretien.php";
$entre = new entretienC;
// Obtenez le nombre total d'utilisateurs actifs et bannis à l'aide des fonctions de votre contrôleur user.php
$total_active_users = $entre->countUsersByState("confirmé");
$total_banned_users = $entre->countUsersByState("en attente");

// Données du graphique
$chartData = [
    "series" => [$total_active_users, $total_banned_users],
    "labels" => ['confirmé', 'en attente']
];

// Convertir les données du graphique en JSON
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="chart-morris-entretien.php">statistique entretien</a></li>
							<li><a href="chart-morris-user.php">statistique user</a></li>
