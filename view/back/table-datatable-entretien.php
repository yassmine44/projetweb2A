...
<body>
    <a href="../View/back/table-dattable-entretien.php" class="btn btn-primary">Afficher la liste entretien</a><br>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									<img src="images/entretien.jpg" width="56" alt="">
								</a>
								<div class="dropdown-menu dropdown-menu-end">
									<a href="app-profile.html" class="dropdown-item ai-icon">
										<svg id="icon-entretien1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="widget-basic.html" class="" aria-expanded="false">
							<i class="fas fa-entretien-check"></i>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <form method="POST" action="updateentretien.php">
                                                            ...
                                                            <input type="hidden" value="<?= $entretien['IDE']; ?>" name="IDE">
                                                        </form>
                                                    </td>
                                                    <td>
                                                        <a href="delete.php?IDE=<?= $entretien['IDE']; ?>">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
